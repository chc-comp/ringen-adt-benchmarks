...
(assert (forall ((x_20 Nat_1) (y_3 Nat_1) (r_0 Nat_1))
	(=> (add_0 r_0 x_20 y_3)
	    (add_0 (S_1 r_0) (S_1 x_20) y_3))))
(assert (forall ((y_3 Nat_1))
	(minus_0 Z_1 Z_1 y_3)))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1) (r_0 Nat_1))
	(=> (minus_0 r_0 x_20 y_3)
	    (minus_0 (S_1 r_0) (S_1 x_20) y_3))))
(assert (forall ((y_3 Nat_1))
	(le_0 Z_1 y_3)))
...
(assert (forall ((y_3 Nat_1))
	(mult_0 Z_1 Z_1 y_3)))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (mult_0 r_0 x_20 y_3)
			(add_0 z_2 r_0 y_3))
		(mult_0 z_2 (S_1 x_20) y_3))))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1))
	(=> (lt_0 x_20 y_3)
	    (div_0 Z_1 x_20 y_3))))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
...
(assert (forall ((x_6 list_0) (x_18 Nat_0) (x_19 list_0))
	(=>	(and (diseqlist_0 x_19 x_6)
			(length_0 x_18 x_6)
			(rotate_0 x_19 x_18 x_6))
		false)))
(check-sat)
