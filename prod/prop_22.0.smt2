...
(assert (forall ((x_1 Nat_0) (y_1 Nat_0) (z_0 Nat_0) (x_8 Bool) (x_9 Bool))
	(=>	(and (= x_8 x_9)
			(even_0 x_9 z_0)
			(= x_1 (S_0 y_1))
			(= y_1 (S_0 z_0)))
...
(assert (forall ((x_3 list_0) (y_2 list_0) (x_14 list_0))
	(=>	(and (= x_14 y_2)
			(= x_3 nil_0))
		(x_2 x_14 x_3 y_2))))
(assert (forall ((x_4 list_0) (y_3 list_0) (x_15 list_0) (x_16 Nat_0) (x_17 Bool) (x_18 list_0) (x_19 Nat_0) (x_20 Bool))
	(=>	(and (not (= x_17 x_20))
			(x_2 x_15 x_4 y_3)
			(length_0 x_16 x_15)
			(even_0 x_17 x_16)
