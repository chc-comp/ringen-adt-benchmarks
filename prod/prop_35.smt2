...
(assert (forall ((x_15 Nat_0) (x_16 Nat_0) (n_0 Nat_0) (x_4 Nat_0))
	(=> (and (exp_0 x_16 x_4 n_0) (x_2 x_15 x_4 x_16)) (exp_0 x_15 x_4 (S_0 n_0)))))
(assert (forall ((x_4 Nat_0))
	(exp_0 (S_0 Z_0) x_4 Z_0)))
(assert (forall ((x_19 Nat_0) (x_20 Nat_0) (n_1 Nat_0) (x_5 Nat_0) (z_3 Nat_0))
	(=> (and (x_2 x_20 x_5 z_3) (qexp_0 x_19 x_5 n_1 x_20)) (qexp_0 x_19 x_5 (S_0 n_1) z_3))))
...
(assert (forall ((x_23 Nat_0) (x_24 Nat_0) (x_25 Nat_0) (x_6 Nat_0) (y_4 Nat_0))
	(=> (and (diseqNat_0 x_23 x_25) (exp_0 x_23 x_6 y_4) (one_0 x_24) (qexp_0 x_25 x_6 y_4 x_24)) false)))
(check-sat)
(get-model)
