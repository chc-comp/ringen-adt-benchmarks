...
(assert (forall ((y_3 Nat_0))
	(mult_0 Z_0 Z_0 y_3)))
(assert (forall ((x_17 Nat_0) (y_3 Nat_0) (r_0 Nat_0) (z_2 Nat_0))
	(=>	(and (mult_0 r_0 x_17 y_3)
			(add_0 z_2 r_0 y_3))
		(mult_0 z_2 (S_0 x_17) y_3))))
(assert (forall ((x_17 Nat_0) (y_3 Nat_0))
	(=> (lt_0 x_17 y_3)
	    (div_0 Z_0 x_17 y_3))))
(assert (forall ((x_17 Nat_0) (y_3 Nat_0) (r_0 Nat_0) (z_2 Nat_0))
...
(assert (forall ((x_3 list_0) (x_14 list_0))
	(=>	(and (= x_14 nil_0)
			(= x_3 nil_0))
		(rev_0 x_14 x_3))))
(assert (forall ((x_4 list_0) (x_15 list_0) (x_16 list_0))
	(=>	(and (diseqlist_0 x_15 x_16)
			(rev_0 x_15 x_4)
			(qrev_0 x_16 x_4 nil_0))
		false)))
(check-sat)
