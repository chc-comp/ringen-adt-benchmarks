...
(assert (forall ((x_24 list_0) (z_3 Nat_0) (xs_1 list_0) (y_4 list_0))
	(=> (and (intersect_0 x_24 xs_1 y_4) (elem_0 true_0 z_3 y_4)) (intersect_0 (cons_0 z_3 x_24) (cons_0 z_3 xs_1) y_4))))
(assert (forall ((x_26 list_0) (x_25 Bool_0) (z_3 Nat_0) (xs_1 list_0) (y_4 list_0))
	(=> (and (diseqBool_0 x_25 true_0) (intersect_0 x_26 xs_1 y_4) (elem_0 x_25 z_3 y_4)) (intersect_0 x_26 (cons_0 z_3 xs_1) y_4))))
...
(assert (forall ((x_36 list_0) (x_9 list_0) (y_7 list_0))
	(=> (and (diseqlist_0 x_36 x_9) (subset_0 true_0 x_9 y_7) (intersect_0 x_36 x_9 y_7)) false)))
(check-sat)
(get-model)
