...
(assert (forall ((y_7 Nat_1))
	(mult_0 Z_1 Z_1 y_7)))
(assert (forall ((x_34 Nat_1) (y_7 Nat_1) (r_0 Nat_1) (z_5 Nat_1))
	(=>	(and (mult_0 r_0 x_34 y_7)
			(add_0 z_5 r_0 y_7))
		(mult_0 z_5 (S_1 x_34) y_7))))
(assert (forall ((x_34 Nat_1) (y_7 Nat_1))
	(=> (lt_0 x_34 y_7)
	    (div_0 Z_1 x_34 y_7))))
(assert (forall ((x_34 Nat_1) (y_7 Nat_1) (r_0 Nat_1) (z_5 Nat_1))
	(=>	(and (ge_0 x_34 y_7)
			(minus_0 z_5 x_34 y_7)
			(div_0 r_0 z_5 y_7))
...
(assert (forall ((x_9 Nat_0) (y_6 Nat_0) (z_4 list_0) (x_32 list_0) (x_33 Bool))
	(=>	(and (= x_33 false)
			(= x_9 y_6)
			(insert_0 x_32 y_6 z_4)
