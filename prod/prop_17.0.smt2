...
(assert (forall ((y_3 Nat_0))
	(mult_0 Z_0 Z_0 y_3)))
(assert (forall ((x_19 Nat_0) (y_3 Nat_0) (r_0 Nat_0) (z_1 Nat_0))
	(=>	(and (mult_0 r_0 x_19 y_3)
			(add_0 z_1 r_0 y_3))
		(mult_0 z_1 (S_0 x_19) y_3))))
(assert (forall ((x_19 Nat_0) (y_3 Nat_0))
	(=> (lt_0 x_19 y_3)
	    (div_0 Z_0 x_19 y_3))))
(assert (forall ((x_19 Nat_0) (y_3 Nat_0) (r_0 Nat_0) (z_1 Nat_0))
	(=>	(and (ge_0 x_19 y_3)
			(minus_0 z_1 x_19 y_3)
			(div_0 r_0 z_1 y_3))
...
(assert (forall ((x_2 list_0) (x_10 list_0))
	(=>	(and (= x_10 nil_0)
			(= x_2 nil_0))
		(rev_0 x_10 x_2))))
(assert (forall ((x_3 list_0) (y_2 list_0) (x_11 list_0) (x_12 list_0) (x_13 list_0) (x_14 list_0) (x_15 list_0) (x_16 list_0) (x_17 list_0) (x_18 list_0))
