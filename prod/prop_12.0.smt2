...
(assert (forall ((y_4 Nat_0))
	(add_0 y_4 Z_0 y_4)))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0) (r_0 Nat_0))
	(=> (add_0 r_0 x_18 y_4)
	    (add_0 (S_0 r_0) (S_0 x_18) y_4))))
(assert (forall ((y_4 Nat_0))
	(minus_0 Z_0 Z_0 y_4)))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0) (r_0 Nat_0))
	(=> (minus_0 r_0 x_18 y_4)
	    (minus_0 (S_0 r_0) (S_0 x_18) y_4))))
(assert (forall ((y_4 Nat_0))
	(le_0 Z_0 y_4)))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0))
	(=> (le_0 x_18 y_4)
	    (le_0 (S_0 x_18) (S_0 y_4)))))
(assert (forall ((y_4 Nat_0))
	(ge_0 y_4 Z_0)))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0))
	(=> (ge_0 x_18 y_4)
	    (ge_0 (S_0 x_18) (S_0 y_4)))))
(assert (forall ((y_4 Nat_0))
	(lt_0 Z_0 (S_0 y_4))))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0))
	(=> (lt_0 x_18 y_4)
	    (lt_0 (S_0 x_18) (S_0 y_4)))))
(assert (forall ((y_4 Nat_0))
	(gt_0 (S_0 y_4) Z_0)))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0))
	(=> (gt_0 x_18 y_4)
	    (gt_0 (S_0 x_18) (S_0 y_4)))))
(assert (forall ((y_4 Nat_0))
	(mult_0 Z_0 Z_0 y_4)))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0) (r_0 Nat_0) (z_2 Nat_0))
	(=>	(and (mult_0 r_0 x_18 y_4)
			(add_0 z_2 r_0 y_4))
		(mult_0 z_2 (S_0 x_18) y_4))))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0))
	(=> (lt_0 x_18 y_4)
	    (div_0 Z_0 x_18 y_4))))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0) (r_0 Nat_0) (z_2 Nat_0))
	(=>	(and (ge_0 x_18 y_4)
			(minus_0 z_2 x_18 y_4)
			(div_0 r_0 z_2 y_4))
		(div_0 (S_0 r_0) x_18 y_4))))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0))
	(=> (lt_0 x_18 y_4)
	    (mod_0 x_18 x_18 y_4))))
(assert (forall ((x_18 Nat_0) (y_4 Nat_0) (r_0 Nat_0) (z_2 Nat_0))
...
(assert (forall ((x_0 list_0) (y_0 list_0) (z_0 Nat_0) (xs_0 list_0) (x_5 list_0) (x_6 list_0))
	(=>	(and (= x_5 x_6)
...
(assert (forall ((x_2 list_0) (y_1 list_0) (z_1 Nat_0) (xs_1 list_0) (x_8 list_0) (x_9 list_0))
...
(assert (forall ((x_3 list_0) (y_2 Nat_0) (xs_2 list_0) (x_11 list_0) (x_12 list_0) (x_13 list_0))
	(=>	(and (= x_11 x_13)
			(rev_0 x_12 xs_2)
...
(assert (forall ((x_3 list_0) (x_14 list_0))
	(=>	(and (= x_14 nil_0)
			(= x_3 nil_0))
		(rev_0 x_14 x_3))))
(assert (forall ((x_4 list_0) (y_3 list_0) (x_15 list_0) (x_16 list_0) (x_17 list_0))
