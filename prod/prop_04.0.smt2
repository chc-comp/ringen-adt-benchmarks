...
(assert (forall ((x_1 Nat_0) (y_1 Nat_0) (x_8 Nat_0) (x_9 Nat_0))
	(=>	(and (= x_8 (S_0 (S_0 x_9)))
			(double_0 x_9 y_1)
			(= x_1 (S_0 y_1)))
		(double_0 x_8 x_1))))
(assert (forall ((x_1 Nat_0) (x_10 Nat_0))
	(=>	(and (= x_10 Z_0)
			(= x_1 Z_0))
		(double_0 x_10 x_1))))
(declare-fun x_2 (list_0 list_0 list_0) Bool)
(assert (forall ((x_3 list_0) (y_2 list_0) (z_0 Nat_1) (xs_1 list_0) (x_11 list_0) (x_12 list_0))
	(=>	(and (= x_11 (cons_0 z_0 x_12))
			(x_2 x_12 xs_1 y_2)
			(= x_3 (cons_0 z_0 xs_1)))
		(x_2 x_11 x_3 y_2))))
(assert (forall ((x_3 list_0) (y_2 list_0) (x_13 list_0))
	(=>	(and (= x_13 y_2)
			(= x_3 nil_0))
		(x_2 x_13 x_3 y_2))))
(assert (forall ((x_4 list_0) (x_14 list_0) (x_15 Nat_0) (x_16 Nat_0) (x_17 Nat_0))
	(=>	(and (diseqNat_1 x_15 x_17)
			(x_2 x_14 x_4 x_4)
			(length_0 x_15 x_14)
			(length_0 x_16 x_4)
			(double_0 x_17 x_16))
