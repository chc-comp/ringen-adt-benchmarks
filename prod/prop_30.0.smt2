...
(assert (forall ((y_2 Nat_0))
	(add_0 y_2 Z_0 y_2)))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0) (r_0 Nat_0))
	(=> (add_0 r_0 x_14 y_2)
	    (add_0 (S_0 r_0) (S_0 x_14) y_2))))
(assert (forall ((y_2 Nat_0))
	(minus_0 Z_0 Z_0 y_2)))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0) (r_0 Nat_0))
	(=> (minus_0 r_0 x_14 y_2)
	    (minus_0 (S_0 r_0) (S_0 x_14) y_2))))
(assert (forall ((y_2 Nat_0))
	(le_0 Z_0 y_2)))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0))
	(=> (le_0 x_14 y_2)
	    (le_0 (S_0 x_14) (S_0 y_2)))))
(assert (forall ((y_2 Nat_0))
	(ge_0 y_2 Z_0)))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0))
	(=> (ge_0 x_14 y_2)
	    (ge_0 (S_0 x_14) (S_0 y_2)))))
(assert (forall ((y_2 Nat_0))
	(lt_0 Z_0 (S_0 y_2))))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0))
	(=> (lt_0 x_14 y_2)
	    (lt_0 (S_0 x_14) (S_0 y_2)))))
(assert (forall ((y_2 Nat_0))
	(gt_0 (S_0 y_2) Z_0)))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0))
	(=> (gt_0 x_14 y_2)
	    (gt_0 (S_0 x_14) (S_0 y_2)))))
(assert (forall ((y_2 Nat_0))
	(mult_0 Z_0 Z_0 y_2)))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0) (r_0 Nat_0) (z_1 Nat_0))
	(=>	(and (mult_0 r_0 x_14 y_2)
			(add_0 z_1 r_0 y_2))
		(mult_0 z_1 (S_0 x_14) y_2))))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0))
	(=> (lt_0 x_14 y_2)
	    (div_0 Z_0 x_14 y_2))))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0) (r_0 Nat_0) (z_1 Nat_0))
	(=>	(and (ge_0 x_14 y_2)
			(minus_0 z_1 x_14 y_2)
			(div_0 r_0 z_1 y_2))
		(div_0 (S_0 r_0) x_14 y_2))))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0))
	(=> (lt_0 x_14 y_2)
	    (mod_0 x_14 x_14 y_2))))
(assert (forall ((x_14 Nat_0) (y_2 Nat_0) (r_0 Nat_0) (z_1 Nat_0))
...
(assert (forall ((x_2 list_0) (x_10 list_0))
	(=>	(and (= x_10 nil_0)
			(= x_2 nil_0))
		(rev_0 x_10 x_2))))
(assert (forall ((x_3 list_0) (x_11 list_0) (x_12 list_0) (x_13 list_0))
