...
(assert (forall ((y_5 Nat_1))
	(mult_0 Z_1 Z_1 y_5)))
(assert (forall ((x_26 Nat_1) (y_5 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (mult_0 r_0 x_26 y_5)
			(add_0 z_2 r_0 y_5))
		(mult_0 z_2 (S_1 x_26) y_5))))
(assert (forall ((x_26 Nat_1) (y_5 Nat_1))
	(=> (lt_0 x_26 y_5)
	    (div_0 Z_1 x_26 y_5))))
(assert (forall ((x_26 Nat_1) (y_5 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (ge_0 x_26 y_5)
			(minus_0 z_2 x_26 y_5)
			(div_0 r_0 z_2 y_5))
...
(assert (forall ((x_2 Nat_0) (y_1 Nat_0) (z_0 Nat_0) (x_10 Nat_0) (x_11 Nat_0))
	(=>	(and (= x_10 (S_0 x_11))
			(x_1 x_11 z_0 y_1)
			(= x_2 (S_0 z_0)))
		(x_1 x_10 x_2 y_1))))
(assert (forall ((x_2 Nat_0) (y_1 Nat_0) (x_12 Nat_0))
	(=>	(and (= x_12 y_1)
			(= x_2 Z_0))
		(x_1 x_12 x_2 y_1))))
(declare-fun x_3 (list_0 list_0 list_0) Bool)
(assert (forall ((x_4 list_0) (y_2 list_0) (z_1 Nat_1) (xs_1 list_0) (x_13 list_0) (x_14 list_0))
	(=>	(and (= x_13 (cons_0 z_1 x_14))
			(x_3 x_14 xs_1 y_2)
			(= x_4 (cons_0 z_1 xs_1)))
		(x_3 x_13 x_4 y_2))))
(assert (forall ((x_4 list_0) (y_2 list_0) (x_15 list_0))
	(=>	(and (= x_15 y_2)
			(= x_4 nil_0))
		(x_3 x_15 x_4 y_2))))
(declare-fun rev_0 (list_0 list_0) Bool)
(assert (forall ((x_5 list_0) (y_3 Nat_1) (xs_2 list_0) (x_16 list_0) (x_17 list_0) (x_18 list_0))
	(=>	(and (= x_16 x_18)
			(rev_0 x_17 xs_2)
			(x_3 x_18 x_17 (cons_0 y_3 nil_0))
			(= x_5 (cons_0 y_3 xs_2)))
		(rev_0 x_16 x_5))))
(assert (forall ((x_5 list_0) (x_19 list_0))
	(=>	(and (= x_19 nil_0)
			(= x_5 nil_0))
		(rev_0 x_19 x_5))))
(assert (forall ((x_6 list_0) (y_4 list_0) (x_20 list_0) (x_21 list_0) (x_22 Nat_0) (x_23 Nat_0) (x_24 Nat_0) (x_25 Nat_0))
	(=>	(and (diseqNat_1 x_22 x_25)
			(x_3 x_20 x_6 y_4)
			(rev_0 x_21 x_20)
			(length_0 x_22 x_21)
			(length_0 x_23 x_6)
