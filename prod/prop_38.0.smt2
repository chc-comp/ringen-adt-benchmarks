...
(assert (forall ((y_6 Nat_1))
	(add_0 y_6 Z_1 y_6)))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1) (r_0 Nat_1))
	(=> (add_0 r_0 x_27 y_6)
	    (add_0 (S_1 r_0) (S_1 x_27) y_6))))
(assert (forall ((y_6 Nat_1))
	(minus_0 Z_1 Z_1 y_6)))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1) (r_0 Nat_1))
	(=> (minus_0 r_0 x_27 y_6)
	    (minus_0 (S_1 r_0) (S_1 x_27) y_6))))
(assert (forall ((y_6 Nat_1))
	(le_0 Z_1 y_6)))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1))
	(=> (le_0 x_27 y_6)
	    (le_0 (S_1 x_27) (S_1 y_6)))))
(assert (forall ((y_6 Nat_1))
	(ge_0 y_6 Z_1)))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1))
	(=> (ge_0 x_27 y_6)
	    (ge_0 (S_1 x_27) (S_1 y_6)))))
(assert (forall ((y_6 Nat_1))
	(lt_0 Z_1 (S_1 y_6))))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1))
	(=> (lt_0 x_27 y_6)
	    (lt_0 (S_1 x_27) (S_1 y_6)))))
(assert (forall ((y_6 Nat_1))
	(gt_0 (S_1 y_6) Z_1)))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1))
	(=> (gt_0 x_27 y_6)
	    (gt_0 (S_1 x_27) (S_1 y_6)))))
(assert (forall ((y_6 Nat_1))
	(mult_0 Z_1 Z_1 y_6)))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1) (r_0 Nat_1) (z_4 Nat_1))
	(=>	(and (mult_0 r_0 x_27 y_6)
			(add_0 z_4 r_0 y_6))
		(mult_0 z_4 (S_1 x_27) y_6))))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1))
	(=> (lt_0 x_27 y_6)
	    (div_0 Z_1 x_27 y_6))))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1) (r_0 Nat_1) (z_4 Nat_1))
	(=>	(and (ge_0 x_27 y_6)
			(minus_0 z_4 x_27 y_6)
			(div_0 r_0 z_4 y_6))
		(div_0 (S_1 r_0) x_27 y_6))))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1))
	(=> (lt_0 x_27 y_6)
	    (mod_0 x_27 x_27 y_6))))
(assert (forall ((x_27 Nat_1) (y_6 Nat_1) (r_0 Nat_1) (z_4 Nat_1))
...
(assert (forall ((x_6 list_0) (y_4 list_0) (x_22 list_0))
	(=>	(and (= x_22 y_4)
			(= x_6 nil_0))
		(x_5 x_22 x_6 y_4))))
(assert (forall ((x_7 Nat_0) (y_5 list_0) (z_3 list_0) (x_23 list_0) (x_24 Bool) (x_25 Bool) (x_26 Bool))
	(=>	(and (= x_24 false)
			(= x_25 true)
			(= x_26 true)
			(x_5 x_23 y_5 z_3)
