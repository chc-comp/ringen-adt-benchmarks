...
(assert (forall ((x_14 Nat_1) (y_3 Nat_1) (r_0 Nat_1))
	(=> (add_0 r_0 x_14 y_3)
	    (add_0 (S_1 r_0) (S_1 x_14) y_3))))
(assert (forall ((y_3 Nat_1))
	(minus_0 Z_1 Z_1 y_3)))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1) (r_0 Nat_1))
	(=> (minus_0 r_0 x_14 y_3)
	    (minus_0 (S_1 r_0) (S_1 x_14) y_3))))
(assert (forall ((y_3 Nat_1))
	(le_0 Z_1 y_3)))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1))
	(=> (le_0 x_14 y_3)
	    (le_0 (S_1 x_14) (S_1 y_3)))))
(assert (forall ((y_3 Nat_1))
	(ge_0 y_3 Z_1)))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1))
	(=> (ge_0 x_14 y_3)
	    (ge_0 (S_1 x_14) (S_1 y_3)))))
(assert (forall ((y_3 Nat_1))
	(lt_0 Z_1 (S_1 y_3))))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1))
	(=> (lt_0 x_14 y_3)
	    (lt_0 (S_1 x_14) (S_1 y_3)))))
(assert (forall ((y_3 Nat_1))
	(gt_0 (S_1 y_3) Z_1)))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1))
	(=> (gt_0 x_14 y_3)
	    (gt_0 (S_1 x_14) (S_1 y_3)))))
(assert (forall ((y_3 Nat_1))
	(mult_0 Z_1 Z_1 y_3)))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1) (r_0 Nat_1) (z_1 Nat_1))
	(=>	(and (mult_0 r_0 x_14 y_3)
			(add_0 z_1 r_0 y_3))
		(mult_0 z_1 (S_1 x_14) y_3))))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1))
	(=> (lt_0 x_14 y_3)
	    (div_0 Z_1 x_14 y_3))))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1) (r_0 Nat_1) (z_1 Nat_1))
	(=>	(and (ge_0 x_14 y_3)
			(minus_0 z_1 x_14 y_3)
			(div_0 r_0 z_1 y_3))
		(div_0 (S_1 r_0) x_14 y_3))))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1))
	(=> (lt_0 x_14 y_3)
	    (mod_0 x_14 x_14 y_3))))
(assert (forall ((x_14 Nat_1) (y_3 Nat_1) (r_0 Nat_1) (z_1 Nat_1))
...
(assert (forall ((x_0 list_0) (y_0 Nat_1) (xs_0 list_0) (x_4 Nat_0) (x_5 Nat_0))
	(=>	(and (= x_4 (S_0 x_5))
			(length_0 x_5 xs_0)
			(= x_0 (cons_0 y_0 xs_0)))
		(length_0 x_4 x_0))))
(assert (forall ((x_0 list_0) (x_6 Nat_0))
	(=>	(and (= x_6 Z_0)
			(= x_0 nil_0))
		(length_0 x_6 x_0))))
(declare-fun x_1 (list_0 list_0 list_0) Bool)
(assert (forall ((x_2 list_0) (y_1 list_0) (z_0 Nat_1) (xs_1 list_0) (x_7 list_0) (x_8 list_0))
	(=>	(and (= x_7 (cons_0 z_0 x_8))
			(x_1 x_8 xs_1 y_1)
			(= x_2 (cons_0 z_0 xs_1)))
		(x_1 x_7 x_2 y_1))))
(assert (forall ((x_2 list_0) (y_1 list_0) (x_9 list_0))
	(=>	(and (= x_9 y_1)
			(= x_2 nil_0))
		(x_1 x_9 x_2 y_1))))
(assert (forall ((x_3 list_0) (y_2 list_0) (x_10 list_0) (x_11 Nat_0) (x_12 list_0) (x_13 Nat_0))
