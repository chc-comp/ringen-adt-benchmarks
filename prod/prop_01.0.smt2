...
(assert (forall ((x_0 Nat_0) (y_0 Nat_0) (x_4 Nat_0) (x_5 Nat_0))
	(=>	(and (= x_4 (S_0 (S_0 x_5)))
			(double_0 x_5 y_0)
			(= x_0 (S_0 y_0)))
		(double_0 x_4 x_0))))
(assert (forall ((x_0 Nat_0) (x_6 Nat_0))
	(=>	(and (= x_6 Z_0)
			(= x_0 Z_0))
		(double_0 x_6 x_0))))
(declare-fun x_1 (Nat_0 Nat_0 Nat_0) Bool)
(assert (forall ((x_2 Nat_0) (y_1 Nat_0) (z_0 Nat_0) (x_7 Nat_0) (x_8 Nat_0))
	(=>	(and (= x_7 (S_0 x_8))
			(x_1 x_8 z_0 y_1)
			(= x_2 (S_0 z_0)))
		(x_1 x_7 x_2 y_1))))
(assert (forall ((x_2 Nat_0) (y_1 Nat_0) (x_9 Nat_0))
	(=>	(and (= x_9 y_1)
			(= x_2 Z_0))
		(x_1 x_9 x_2 y_1))))
(assert (forall ((x_3 Nat_0) (x_10 Nat_0) (x_11 Nat_0))
