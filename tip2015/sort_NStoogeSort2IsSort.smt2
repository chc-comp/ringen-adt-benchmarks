...
(assert (forall ((x_103 Nat_0) (x_104 Nat_0))
	(=> (diseqNat_0 x_103 x_104) (diseqNat_0 (Z_6 x_103) (Z_6 x_104)))))
(assert (forall ((y_10 Nat_0))
	(add_0 y_10 Z_5 y_10)))
(assert (forall ((r_0 Nat_0) (x_89 Nat_0) (y_10 Nat_0))
	(=> (add_0 r_0 x_89 y_10) (add_0 (Z_6 r_0) (Z_6 x_89) y_10))))
(assert (forall ((y_10 Nat_0))
	(minus_0 Z_5 Z_5 y_10)))
(assert (forall ((r_0 Nat_0) (x_89 Nat_0) (y_10 Nat_0))
	(=> (minus_0 r_0 x_89 y_10) (minus_0 (Z_6 r_0) (Z_6 x_89) y_10))))
(assert (forall ((y_10 Nat_0))
	(le_0 Z_5 y_10)))
(assert (forall ((x_89 Nat_0) (y_10 Nat_0))
	(=> (le_0 x_89 y_10) (le_0 (Z_6 x_89) (Z_6 y_10)))))
(assert (forall ((y_10 Nat_0))
	(gt_0 (Z_6 y_10) Z_5)))
(assert (forall ((x_89 Nat_0) (y_10 Nat_0))
	(=> (gt_0 x_89 y_10) (gt_0 (Z_6 x_89) (Z_6 y_10)))))
...
(assert (forall ((x_115 Nat_0) (x_116 list_0) (x_117 Nat_0) (x_118 list_0))
	(=> (diseqNat_0 x_115 x_117) (diseqlist_0 (cons_0 x_115 x_116) (cons_0 x_117 x_118)))))
(assert (forall ((x_115 Nat_0) (x_116 list_0) (x_117 Nat_0) (x_118 list_0))
	(=> (diseqlist_0 x_116 x_118) (diseqlist_0 (cons_0 x_115 x_116) (cons_0 x_117 x_118)))))
...
(assert (forall ((x_91 Nat_0) (x_27 Nat_0) (x_28 Nat_0) (x_0 Nat_0))
	(=> (and (diseqNat_0 x_0 (Z_6 (Z_6 Z_5))) (diseqNat_0 x_0 (Z_6 Z_5)) (diseqNat_0 x_0 Z_5) (twoThirds_0 x_28 x_91) (minus_0 x_91 x_0 (Z_6 (Z_6 (Z_6 Z_5)))) (add_0 x_27 (Z_6 (Z_6 Z_5)) x_28)) (twoThirds_0 x_27 x_0))))
...
(assert (forall ((x_93 Nat_0) (x_36 Nat_0) (x_37 Nat_0) (x_1 Nat_0))
	(=> (and (diseqNat_0 x_1 (Z_6 (Z_6 Z_5))) (diseqNat_0 x_1 (Z_6 Z_5)) (diseqNat_0 x_1 Z_5) (third_0 x_37 x_93) (minus_0 x_93 x_1 (Z_6 (Z_6 (Z_6 Z_5)))) (add_0 x_36 (Z_6 Z_5) x_37)) (third_0 x_36 x_1))))
...
(assert (forall ((x_94 Nat_0) (x_40 list_0) (z_0 Nat_0) (xs_0 list_0) (x_2 Nat_0))
	(=> (and (gt_0 x_2 Z_5) (take_0 x_40 x_94 xs_0) (minus_0 x_94 x_2 (Z_6 Z_5))) (take_0 (cons_0 z_0 x_40) x_2 (cons_0 z_0 xs_0)))))
(assert (forall ((x_2 Nat_0) (y_0 list_0))
	(=> (le_0 x_2 Z_5) (take_0 nil_0 x_2 y_0))))
...
(assert (forall ((z_1 Nat_0) (xs_1 list_0) (x_5 Nat_0))
	(=> (le_0 x_5 z_1) (insert_0 (cons_0 x_5 (cons_0 z_1 xs_1)) x_5 (cons_0 z_1 xs_1)))))
(assert (forall ((x_50 list_0) (z_1 Nat_0) (xs_1 list_0) (x_5 Nat_0))
	(=> (and (gt_0 x_5 z_1) (insert_0 x_50 x_5 xs_1)) (insert_0 (cons_0 z_1 x_50) x_5 (cons_0 z_1 xs_1)))))
(assert (forall ((x_5 Nat_0))
	(insert_0 (cons_0 x_5 nil_0) x_5 nil_0)))
(assert (forall ((x_52 list_0) (x_53 list_0) (y_4 Nat_0) (xs_2 list_0))
	(=> (and (isort_0 x_53 xs_2) (insert_0 x_52 y_4 x_53)) (isort_0 x_52 (cons_0 y_4 xs_2)))))
(assert (isort_0 nil_0 nil_0))
(assert (forall ((x_56 list_0) (x_7 Nat_0))
	(=> (le_0 x_7 Z_5) (drop_0 x_56 x_7 x_56))))
(assert (forall ((x_96 Nat_0) (x_57 list_0) (z_2 Nat_0) (xs_3 list_0) (x_7 Nat_0))
	(=> (and (gt_0 x_7 Z_5) (drop_0 x_57 x_96 xs_3) (minus_0 x_96 x_7 (Z_6 Z_5))) (drop_0 x_57 x_7 (cons_0 z_2 xs_3)))))
(assert (forall ((x_59 list_0) (x_7 Nat_0))
	(=> (le_0 x_7 Z_5) (drop_0 x_59 x_7 x_59))))
(assert (forall ((x_7 Nat_0))
	(=> (gt_0 x_7 Z_5) (drop_0 nil_0 x_7 nil_0))))
(assert (forall ((x_62 list_0) (x_63 list_0) (x_8 Nat_0) (y_6 list_0))
	(=> (and (take_0 x_62 x_8 y_6) (drop_0 x_63 x_8 y_6)) (splitAt_0 (pair_1 x_62 x_63) x_8 y_6))))
(assert (forall ((x_65 list_0) (z_3 Nat_0) (xs_4 list_0) (y_7 list_0))
	(=> (x_9 x_65 xs_4 y_7) (x_9 (cons_0 z_3 x_65) (cons_0 z_3 xs_4) y_7))))
(assert (forall ((x_66 list_0))
	(x_9 x_66 nil_0 x_66)))
(assert (forall ((x_70 list_0) (x_71 list_0) (x_67 Nat_0) (x_68 Nat_0) (ys_0 list_0) (zs_0 list_0) (x_14 list_0))
	(=> (and (nstoogesort_1 x_71 ys_0) (x_9 x_70 x_71 zs_0) (length_0 x_67 x_14) (twoThirds_0 x_68 x_67) (splitAt_0 (pair_1 ys_0 zs_0) x_68 x_14)) (nstoogesort_0 x_70 x_14))))
(assert (forall ((x_73 list_0) (x_74 list_0) (x_75 list_0) (x_17 Nat_0) (x_18 list_0) (y_9 Nat_0) (y_8 Nat_0))
	(=> (and (nstoogesort_0 x_74 (cons_0 y_8 (cons_0 y_9 (cons_0 x_17 x_18)))) (nstoogesort_2 x_75 x_74) (nstoogesort_0 x_73 x_75)) (nstoogesort_1 x_73 (cons_0 y_8 (cons_0 y_9 (cons_0 x_17 x_18)))))))
(assert (forall ((x_77 list_0) (y_9 Nat_0) (y_8 Nat_0))
	(=> (sort_0 x_77 y_8 y_9) (nstoogesort_1 x_77 (cons_0 y_8 (cons_0 y_9 nil_0))))))
...
(assert (forall ((x_84 list_0) (x_85 list_0) (x_81 Nat_0) (x_82 Nat_0) (ys_1 list_0) (zs_1 list_0) (x_19 list_0))
	(=> (and (nstoogesort_1 x_85 zs_1) (x_9 x_84 ys_1 x_85) (length_0 x_81 x_19) (third_0 x_82 x_81) (splitAt_0 (pair_1 ys_1 zs_1) x_82 x_19)) (nstoogesort_2 x_84 x_19))))
(assert (forall ((x_87 list_0) (x_88 list_0) (xs_5 list_0))
	(=> (and (diseqlist_0 x_87 x_88) (nstoogesort_1 x_87 xs_5) (isort_0 x_88 xs_5)) false)))
(check-sat)
(get-model)
