...
(assert (forall ((x_90 Nat_0) (x_91 Nat_0))
	(=> (diseqNat_0 x_90 x_91) (diseqNat_0 (succ_0 x_90) (succ_0 x_91)))))
...
(assert (forall ((x_102 Nat_0) (x_103 Nat_0))
	(=> (diseqNat_0 x_102 x_103) (diseqInteger_0 (P_1 x_102) (P_1 x_103)))))
(assert (forall ((x_104 Nat_0) (x_105 Nat_0))
	(=> (diseqNat_0 x_104 x_105) (diseqInteger_0 (N_0 x_104) (N_0 x_105)))))
...
(assert (forall ((x_49 Integer_0) (x_50 Integer_0) (x_51 Integer_0) (x_52 Integer_0) (x_8 Integer_0) (y_6 Integer_0) (z_4 Integer_0))
	(=> (and (diseqInteger_0 x_50 x_52) (times_1 x_49 y_6 z_4) (times_1 x_50 x_8 x_49) (times_1 x_51 x_8 y_6) (times_1 x_52 x_51 z_4)) false)))
(assert (forall ((x_53 Nat_0) (x_54 Nat_0) (x_55 Nat_0) (x_56 Nat_0) (x_9 Nat_0) (y_7 Nat_0) (z_5 Nat_0))
	(=> (and (diseqNat_0 x_54 x_56) (times_0 x_53 y_7 z_5) (times_0 x_54 x_9 x_53) (times_0 x_55 x_9 y_7) (times_0 x_56 x_55 z_5)) false)))
(assert (forall ((x_57 Nat_0) (x_58 Nat_0) (x_59 Nat_0) (x_60 Nat_0) (x_10 Nat_0) (y_8 Nat_0) (z_6 Nat_0))
	(=> (and (diseqNat_0 x_58 x_60) (plus_0 x_57 y_8 z_6) (plus_0 x_58 x_10 x_57) (plus_0 x_59 x_10 y_8) (plus_0 x_60 x_59 z_6)) false)))
(assert (forall ((x_61 Nat_0) (x_62 Nat_0) (x_11 Nat_0) (y_9 Nat_0))
	(=> (and (diseqNat_0 x_61 x_62) (times_0 x_61 x_11 y_9) (times_0 x_62 y_9 x_11)) false)))
(assert (forall ((x_63 Nat_0) (x_64 Nat_0) (x_12 Nat_0) (y_10 Nat_0))
	(=> (and (diseqNat_0 x_63 x_64) (plus_0 x_63 x_12 y_10) (plus_0 x_64 y_10 x_12)) false)))
(assert (forall ((x_65 Nat_0) (x_66 Nat_0) (x_67 Nat_0) (x_68 Nat_0) (x_69 Nat_0) (x_13 Nat_0) (y_11 Nat_0) (z_7 Nat_0))
	(=> (and (diseqNat_0 x_66 x_69) (plus_0 x_65 y_11 z_7) (times_0 x_66 x_13 x_65) (times_0 x_67 x_13 y_11) (times_0 x_68 x_13 z_7) (plus_0 x_69 x_67 x_68)) false)))
(assert (forall ((x_70 Nat_0) (x_71 Nat_0) (x_72 Nat_0) (x_73 Nat_0) (x_74 Nat_0) (x_14 Nat_0) (y_12 Nat_0) (z_8 Nat_0))
	(=> (and (diseqNat_0 x_71 x_74) (plus_0 x_70 x_14 y_12) (times_0 x_71 x_70 z_8) (times_0 x_72 x_14 z_8) (times_0 x_73 y_12 z_8) (plus_0 x_74 x_72 x_73)) false)))
(assert (forall ((x_75 Nat_0) (x_15 Nat_0))
	(=> (and (diseqNat_0 x_75 x_15) (times_0 x_75 x_15 (succ_0 zero_0))) false)))
(assert (forall ((x_76 Nat_0) (x_16 Nat_0))
	(=> (and (diseqNat_0 x_76 x_16) (times_0 x_76 (succ_0 zero_0) x_16)) false)))
(assert (forall ((x_77 Nat_0) (x_17 Nat_0))
	(=> (and (diseqNat_0 x_77 x_17) (plus_0 x_77 x_17 zero_0)) false)))
(assert (forall ((x_78 Nat_0) (x_18 Nat_0))
	(=> (and (diseqNat_0 x_78 x_18) (plus_0 x_78 zero_0 x_18)) false)))
(assert (forall ((x_79 Nat_0) (x_19 Nat_0))
	(=> (and (diseqNat_0 x_79 zero_0) (times_0 x_79 x_19 zero_0)) false)))
(assert (forall ((x_80 Nat_0) (x_20 Nat_0))
	(=> (and (diseqNat_0 x_80 zero_0) (times_0 x_80 zero_0 x_20)) false)))
(check-sat)
(get-model)
