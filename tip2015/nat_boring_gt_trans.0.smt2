...
(assert (forall ((x_12 Nat_1) (y_3 Nat_1))
	(=> (lt_1 x_12 y_3)
	    (lt_1 (S_0 x_12) (S_0 y_3)))))
(assert (forall ((y_3 Nat_1))
	(gt_1 (S_0 y_3) Z_0)))
(assert (forall ((x_12 Nat_1) (y_3 Nat_1))
	(=> (gt_1 x_12 y_3)
	    (gt_1 (S_0 x_12) (S_0 y_3)))))
(assert (forall ((y_3 Nat_1))
	(mult_0 Z_0 Z_0 y_3)))
(assert (forall ((x_12 Nat_1) (y_3 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (mult_0 r_0 x_12 y_3)
			(add_0 z_2 r_0 y_3))
		(mult_0 z_2 (S_0 x_12) y_3))))
(assert (forall ((x_12 Nat_1) (y_3 Nat_1))
	(=> (lt_1 x_12 y_3)
	    (div_0 Z_0 x_12 y_3))))
(assert (forall ((x_12 Nat_1) (y_3 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (ge_0 x_12 y_3)
			(minus_0 z_2 x_12 y_3)
			(div_0 r_0 z_2 y_3))
...
(assert (forall ((x_1 Nat_0) (y_1 Nat_0) (x_7 Bool) (x_8 Bool))
	(=>	(and (= x_7 x_8)
			(lt_0 x_8 y_1 x_1))
		(gt_0 x_7 x_1 y_1))))
(assert (forall ((x_2 Nat_0) (y_2 Nat_0) (z_1 Nat_0) (x_9 Bool) (x_10 Bool) (x_11 Bool))
	(=>	(and (= x_9 false)
			(= x_10 true)
			(= x_11 true)
			(gt_0 x_9 x_2 z_1)
