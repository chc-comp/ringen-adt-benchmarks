...
(assert (forall ((x_34 Nat_0) (x_35 Nat_0) (n_4 Nat_0) (m_1 Nat_0))
	(=> (and (plus_0 x_34 (succ_0 zero_0) m_1) (plus_0 x_35 x_34 n_4)) (plus_1 (N_0 x_35) (N_0 m_1) (N_0 n_4)))))
(assert (forall ((x_36 Integer_0) (x_37 Nat_0) (n_3 Nat_0) (m_1 Nat_0))
	(=> (and (plus_0 x_37 (succ_0 zero_0) m_1) (x_2 x_36 n_3 x_37)) (plus_1 x_36 (N_0 m_1) (P_1 n_3)))))
(assert (forall ((x_39 Integer_0) (x_40 Nat_0) (o_0 Nat_0) (m_0 Nat_0))
	(=> (and (plus_0 x_40 (succ_0 zero_0) o_0) (x_2 x_39 m_0 x_40)) (plus_1 x_39 (P_1 m_0) (N_0 o_0)))))
(assert (forall ((x_43 Nat_0) (n_2 Nat_0) (m_0 Nat_0))
	(=> (plus_0 x_43 m_0 n_2) (plus_1 (P_1 x_43) (P_1 m_0) (P_1 n_2)))))
(assert (forall ((x_44 Integer_0) (x_45 Integer_0) (x_46 Integer_0) (x_8 Integer_0))
	(=> (and (diseqInteger_0 x_45 x_46) (neg_0 x_44 x_8) (plus_1 x_45 x_44 x_8) (zero_1 x_46)) false)))
(assert (forall ((x_47 Nat_0) (x_48 Nat_0) (x_49 Nat_0) (x_50 Nat_0) (x_9 Nat_0) (y_4 Nat_0) (z_3 Nat_0))
	(=> (and (diseqNat_0 x_48 x_50) (plus_0 x_47 y_4 z_3) (plus_0 x_48 x_9 x_47) (plus_0 x_49 x_9 y_4) (plus_0 x_50 x_49 z_3)) false)))
(assert (forall ((x_51 Nat_0) (x_52 Nat_0) (x_10 Nat_0) (y_5 Nat_0))
	(=> (and (diseqNat_0 x_51 x_52) (plus_0 x_51 x_10 y_5) (plus_0 x_52 y_5 x_10)) false)))
(assert (forall ((x_53 Nat_0) (x_11 Nat_0))
	(=> (and (diseqNat_0 x_53 x_11) (plus_0 x_53 x_11 zero_0)) false)))
(assert (forall ((x_54 Nat_0) (x_12 Nat_0))
	(=> (and (diseqNat_0 x_54 x_12) (plus_0 x_54 zero_0 x_12)) false)))
(check-sat)
(get-model)
