...
(assert (forall ((x_12 Bool_0) (x_2 It_0) (x_3 list_0) (x_1 list_0))
	(=> (isPrefix_0 x_12 x_1 x_3) (isPrefix_0 x_12 (cons_0 x_2 x_1) (cons_0 x_2 x_3)))))
...
(assert (forall ((x_17 Bool_0) (x_8 It_0) (x_9 list_0) (x_6 It_0) (x_7 list_0))
	(=> (isRelaxedPrefix_0 x_17 (cons_0 x_6 x_7) x_9) (isRelaxedPrefix_0 x_17 (cons_0 x_8 (cons_0 x_6 x_7)) (cons_0 x_8 x_9)))))
(assert (forall ((x_19 Bool_0) (x_8 It_0) (x_9 list_0) (x_6 It_0) (x_7 list_0) (z_1 It_0))
	(=> (and (diseqIt_0 z_1 x_8) (isPrefix_0 x_19 (cons_0 x_6 x_7) (cons_0 x_8 x_9))) (isRelaxedPrefix_0 x_19 (cons_0 z_1 (cons_0 x_6 x_7)) (cons_0 x_8 x_9)))))
...
(assert (forall ((x_25 list_0) (z_2 It_0) (xs_0 list_0) (y_2 list_0))
	(=> (x_10 x_25 xs_0 y_2) (x_10 (cons_0 z_2 x_25) (cons_0 z_2 xs_0) y_2))))
(assert (forall ((x_26 list_0))
	(x_10 x_26 nil_0 x_26)))
(assert (forall ((x_27 list_0) (x_28 Bool_0) (xs_1 list_0) (ys_0 list_0))
	(=> (and (diseqBool_0 x_28 true_0) (x_10 x_27 xs_1 ys_0) (isRelaxedPrefix_0 x_28 xs_1 x_27)) false)))
(check-sat)
(get-model)
