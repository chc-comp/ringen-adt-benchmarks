...
(assert (forall ((y_3 Nat_1))
	(mult_0 Z_0 Z_0 y_3)))
(assert (forall ((x_17 Nat_1) (y_3 Nat_1) (r_0 Nat_1) (z_3 Nat_1))
	(=>	(and (mult_0 r_0 x_17 y_3)
			(add_0 z_3 r_0 y_3))
		(mult_0 z_3 (S_0 x_17) y_3))))
(assert (forall ((x_17 Nat_1) (y_3 Nat_1))
	(=> (lt_0 x_17 y_3)
	    (div_0 Z_0 x_17 y_3))))
(assert (forall ((x_17 Nat_1) (y_3 Nat_1) (r_0 Nat_1) (z_3 Nat_1))
...
(assert (forall ((x_0 Nat_0) (y_0 Nat_0) (z_0 Nat_0) (x_4 Nat_0) (x_5 Nat_0))
	(=>	(and (= x_4 x_5)
			(accplus_0 x_5 z_0 (succ_0 y_0))
			(= x_0 (succ_0 z_0)))
		(accplus_0 x_4 x_0 y_0))))
(assert (forall ((x_0 Nat_0) (y_0 Nat_0) (x_6 Nat_0))
	(=>	(and (= x_6 y_0)
			(= x_0 zero_0))
		(accplus_0 x_6 x_0 y_0))))
(declare-fun accaltmul_0 (Nat_0 Nat_0 Nat_0) Bool)
(assert (forall ((x_1 Nat_0) (y_1 Nat_0) (z_1 Nat_0) (x_2 Nat_0) (x_7 Nat_0) (x_8 Nat_0) (x_9 Nat_0) (x_10 Nat_0))
	(=>	(and (= x_7 x_10)
			(accaltmul_0 x_8 z_1 x_2)
			(accplus_0 x_9 x_2 x_8)
			(accplus_0 x_10 (succ_0 z_1) x_9)
			(= x_1 (succ_0 z_1))
			(= y_1 (succ_0 x_2)))
		(accaltmul_0 x_7 x_1 y_1))))
(assert (forall ((x_1 Nat_0) (y_1 Nat_0) (z_1 Nat_0) (x_11 Nat_0))
	(=>	(and (= x_11 zero_0)
			(= x_1 (succ_0 z_1))
			(= y_1 zero_0))
		(accaltmul_0 x_11 x_1 y_1))))
(assert (forall ((x_1 Nat_0) (y_1 Nat_0) (x_12 Nat_0))
	(=>	(and (= x_12 zero_0)
			(= x_1 zero_0))
		(accaltmul_0 x_12 x_1 y_1))))
(assert (forall ((x_3 Nat_0) (y_2 Nat_0) (z_2 Nat_0) (x_13 Nat_0) (x_14 Nat_0) (x_15 Nat_0) (x_16 Nat_0))
