...
(assert (forall ((x_62 Nat_1) (x_63 Nat_1))
	(=> (diseqNat_1 x_62 x_63) (diseqNat_1 (Z_6 x_62) (Z_6 x_63)))))
...
(assert (forall ((x_44 Nat_1) (x_45 list_0) (x_46 Nat_1) (x_47 list_0))
	(=> (diseqNat_1 x_44 x_46) (diseqlist_0 (cons_0 x_44 x_45) (cons_0 x_46 x_47)))))
(assert (forall ((x_44 Nat_1) (x_45 list_0) (x_46 Nat_1) (x_47 list_0))
	(=> (diseqlist_0 x_45 x_47) (diseqlist_0 (cons_0 x_44 x_45) (cons_0 x_46 x_47)))))
...
(assert (forall ((x_9 list_0) (z_0 Nat_1) (ys_0 list_0) (x_0 Nat_1))
	(=> (snoc_0 x_9 x_0 ys_0) (snoc_0 (cons_0 z_0 x_9) x_0 (cons_0 z_0 ys_0)))))
...
(assert (forall ((x_11 list_0) (x_12 list_0) (z_2 Nat_1) (xs_0 list_0) (z_1 Nat_0))
	(=> (and (snoc_0 x_12 z_2 xs_0) (rotate_0 x_11 z_1 x_12)) (rotate_0 x_11 (succ_0 z_1) (cons_0 z_2 xs_0)))))
...
(assert (forall ((x_17 Nat_0) (z_3 Nat_0) (y_2 Nat_0))
	(=> (plus_0 x_17 z_3 y_2) (plus_0 (succ_0 x_17) (succ_0 z_3) y_2))))
(assert (forall ((x_18 Nat_0))
	(plus_0 x_18 zero_0 x_18)))
(assert (forall ((x_19 Nat_0) (x_20 Nat_0) (y_3 Nat_1) (l_0 list_0))
	(=> (and (length_0 x_20 l_0) (plus_0 x_19 (succ_0 zero_0) x_20)) (length_0 x_19 (cons_0 y_3 l_0)))))
(assert (length_0 zero_0 nil_0))
(assert (forall ((x_23 Nat_0) (x_24 Nat_0) (x_25 Nat_0) (x_26 Nat_0) (x_4 Nat_0) (y_4 Nat_0) (z_4 Nat_0))
	(=> (and (diseqNat_0 x_24 x_26) (plus_0 x_23 y_4 z_4) (plus_0 x_24 x_4 x_23) (plus_0 x_25 x_4 y_4) (plus_0 x_26 x_25 z_4)) false)))
(assert (forall ((x_27 Nat_0) (x_28 Nat_0) (x_5 Nat_0) (y_5 Nat_0))
	(=> (and (diseqNat_0 x_27 x_28) (plus_0 x_27 x_5 y_5) (plus_0 x_28 y_5 x_5)) false)))
(assert (forall ((x_29 Nat_0) (x_6 Nat_0))
	(=> (and (diseqNat_0 x_29 x_6) (plus_0 x_29 x_6 zero_0)) false)))
(assert (forall ((x_30 Nat_0) (x_7 Nat_0))
	(=> (and (diseqNat_0 x_30 x_7) (plus_0 x_30 zero_0 x_7)) false)))
(assert (forall ((x_31 Nat_0) (x_32 list_0) (xs_1 list_0))
	(=> (and (diseqlist_0 x_32 xs_1) (length_0 x_31 xs_1) (rotate_0 x_32 x_31 xs_1)) false)))
(check-sat)
(get-model)
