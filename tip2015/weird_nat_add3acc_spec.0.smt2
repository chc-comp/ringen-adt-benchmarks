...
(assert (forall ((y_5 Nat_1))
	(mult_0 Z_0 Z_0 y_5)))
(assert (forall ((x_28 Nat_1) (y_5 Nat_1) (r_0 Nat_1) (z_4 Nat_1))
	(=>	(and (mult_0 r_0 x_28 y_5)
			(add_0 z_4 r_0 y_5))
		(mult_0 z_4 (S_0 x_28) y_5))))
(assert (forall ((x_28 Nat_1) (y_5 Nat_1))
	(=> (lt_0 x_28 y_5)
	    (div_0 Z_0 x_28 y_5))))
(assert (forall ((x_28 Nat_1) (y_5 Nat_1) (r_0 Nat_1) (z_4 Nat_1))
	(=>	(and (ge_0 x_28 y_5)
			(minus_0 z_4 x_28 y_5)
			(div_0 r_0 z_4 y_5))
...
(assert (forall ((x_1 Nat_0) (y_1 Nat_0) (z_1 Nat_0) (x_2 Nat_0) (x_12 Nat_0) (x_13 Nat_0))
	(=>	(and (= x_12 x_13)
			(addacc_0 x_13 x_2 (succ_0 y_1) z_1)
			(= x_1 (succ_0 x_2)))
		(addacc_0 x_12 x_1 y_1 z_1))))
(assert (forall ((x_1 Nat_0) (y_1 Nat_0) (z_1 Nat_0) (x_3 Nat_0) (x_14 Nat_0) (x_15 Nat_0))
	(=>	(and (= x_14 x_15)
			(addacc_0 x_15 zero_0 x_3 (succ_0 z_1))
			(= x_1 zero_0)
			(= y_1 (succ_0 x_3)))
...
(assert (forall ((x_4 Nat_0) (y_2 Nat_0) (z_2 Nat_0) (x_17 Nat_0) (x_18 Nat_0) (x_19 Nat_0))
	(=>	(and (diseqNat_1 x_17 x_19)
			(addacc_0 x_17 x_4 y_2 z_2)
			(plus_0 x_18 y_2 z_2)
			(plus_0 x_19 x_4 x_18))
		false)))
(assert (forall ((x_5 Nat_0) (y_3 Nat_0) (z_3 Nat_0) (x_20 Nat_0) (x_21 Nat_0) (x_22 Nat_0) (x_23 Nat_0))
	(=>	(and (diseqNat_1 x_21 x_23)
		...
		false)))
(assert (forall ((x_6 Nat_0) (y_4 Nat_0) (x_24 Nat_0) (x_25 Nat_0))
	(=>	(and (diseqNat_1 x_24 x_25)
			(plus_0 x_24 x_6 y_4)
			(plus_0 x_25 y_4 x_6))
		false)))
(assert (forall ((x_7 Nat_0) (x_26 Nat_0))
	(=>	(and (diseqNat_1 x_26 x_7)
			(plus_0 x_26 x_7 zero_0))
		false)))
(assert (forall ((x_8 Nat_0) (x_27 Nat_0))
	(=>	(and (diseqNat_1 x_27 x_8)
