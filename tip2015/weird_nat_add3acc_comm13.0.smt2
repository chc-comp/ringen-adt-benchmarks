...
(assert (forall ((y_2 Nat_1))
	(mult_0 Z_0 Z_0 y_2)))
(assert (forall ((x_11 Nat_1) (y_2 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (mult_0 r_0 x_11 y_2)
			(add_0 z_2 r_0 y_2))
		(mult_0 z_2 (S_0 x_11) y_2))))
(assert (forall ((x_11 Nat_1) (y_2 Nat_1))
	(=> (lt_0 x_11 y_2)
	    (div_0 Z_0 x_11 y_2))))
(assert (forall ((x_11 Nat_1) (y_2 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (ge_0 x_11 y_2)
			(minus_0 z_2 x_11 y_2)
			(div_0 r_0 z_2 y_2))
...
(assert (forall ((x_0 Nat_0) (y_0 Nat_0) (z_0 Nat_0) (x_1 Nat_0) (x_4 Nat_0) (x_5 Nat_0))
	(=>	(and (= x_4 x_5)
			(addacc_0 x_5 x_1 (succ_0 y_0) z_0)
			(= x_0 (succ_0 x_1)))
		(addacc_0 x_4 x_0 y_0 z_0))))
(assert (forall ((x_0 Nat_0) (y_0 Nat_0) (z_0 Nat_0) (x_2 Nat_0) (x_6 Nat_0) (x_7 Nat_0))
	(=>	(and (= x_6 x_7)
			(addacc_0 x_7 zero_0 x_2 (succ_0 z_0))
			(= x_0 zero_0)
			(= y_0 (succ_0 x_2)))
		(addacc_0 x_6 x_0 y_0 z_0))))
(assert (forall ((x_0 Nat_0) (y_0 Nat_0) (z_0 Nat_0) (x_8 Nat_0))
	(=>	(and (= x_8 z_0)
			(= x_0 zero_0)
			(= y_0 zero_0))
		(addacc_0 x_8 x_0 y_0 z_0))))
(assert (forall ((x_3 Nat_0) (y_1 Nat_0) (z_1 Nat_0) (x_9 Nat_0) (x_10 Nat_0))
	(=>	(and (diseqNat_1 x_9 x_10)
			(addacc_0 x_9 x_3 y_1 z_1)
			(addacc_0 x_10 z_1 y_1 x_3))
		false)))
(check-sat)
