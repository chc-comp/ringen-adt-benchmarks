...
(assert (forall ((x_154 Nat_0) (x_155 Nat_0))
	(=> (diseqNat_0 x_154 x_155) (diseqNat_0 (succ_0 x_154) (succ_0 x_155)))))
...
(assert (forall ((x_166 Nat_0) (x_167 list_0) (x_168 Nat_0) (x_169 list_0))
	(=> (diseqNat_0 x_166 x_168) (diseqlist_0 (cons_0 x_166 x_167) (cons_0 x_168 x_169)))))
(assert (forall ((x_166 Nat_0) (x_167 list_0) (x_168 Nat_0) (x_169 list_0))
	(=> (diseqlist_0 x_167 x_169) (diseqlist_0 (cons_0 x_166 x_167) (cons_0 x_168 x_169)))))
...
(assert (forall ((z_7 Nat_0) (xs_1 list_0) (x_9 Nat_0))
	(=> (leq_0 true_0 x_9 z_7) (insert_0 (cons_0 x_9 (cons_0 z_7 xs_1)) x_9 (cons_0 z_7 xs_1)))))
(assert (forall ((x_72 list_0) (x_70 Bool_0) (z_7 Nat_0) (xs_1 list_0) (x_9 Nat_0))
	(=> (and (diseqBool_0 x_70 true_0) (insert_0 x_72 x_9 xs_1) (leq_0 x_70 x_9 z_7)) (insert_0 (cons_0 z_7 x_72) x_9 (cons_0 z_7 xs_1)))))
(assert (forall ((x_9 Nat_0))
	(insert_0 (cons_0 x_9 nil_0) x_9 nil_0)))
(assert (forall ((x_74 list_0) (x_75 list_0) (y_10 Nat_0) (xs_2 list_0))
	(=> (and (isort_0 x_75 xs_2) (insert_0 x_74 y_10 x_75)) (isort_0 x_74 (cons_0 y_10 xs_2)))))
(assert (isort_0 nil_0 nil_0))
(assert (forall ((x_11 Nat_0) (y_11 Nat_0))
	(=> (lt_0 true_0 x_11 y_11) (idiv_0 zero_0 x_11 y_11))))
(assert (forall ((x_82 Nat_0) (x_83 Nat_0) (x_80 Bool_0) (x_11 Nat_0) (y_11 Nat_0))
	(=> (and (diseqBool_0 x_80 true_0) (minus_0 x_82 x_11 y_11) (idiv_0 x_83 x_82 y_11) (lt_0 x_80 x_11 y_11)) (idiv_0 (succ_0 x_83) x_11 y_11))))
(assert (forall ((x_84 list_0) (z_9 Nat_0) (xs_3 list_0) (z_8 Nat_0))
	(=> (drop_0 x_84 z_8 xs_3) (drop_0 x_84 (succ_0 z_8) (cons_0 z_9 xs_3)))))
...
(assert (forall ((x_89 list_0) (x_90 list_0) (x_13 Nat_0) (y_13 list_0))
	(=> (and (take_0 x_89 x_13 y_13) (drop_0 x_90 x_13 y_13)) (splitAt_0 (pair_1 x_89 x_90) x_13 y_13))))
(assert (forall ((x_92 list_0) (z_10 Nat_0) (xs_4 list_0) (y_14 list_0))
	(=> (x_14 x_92 xs_4 y_14) (x_14 (cons_0 z_10 x_92) (cons_0 z_10 xs_4) y_14))))
...
(assert (forall ((x_99 list_0) (x_100 list_0) (x_94 Nat_0) (x_95 Nat_0) (x_96 Nat_0) (ys_0 list_0) (zs_0 list_0) (x_19 list_0))
	(=> (and (stoogesort_1 x_99 ys_0) (x_14 x_100 x_99 zs_0) (length_0 x_94 x_19) (times_0 x_95 (succ_0 (succ_0 zero_0)) x_94) (idiv_0 x_96 (succ_0 x_95) (succ_0 (succ_0 (succ_0 zero_0)))) (splitAt_0 (pair_1 ys_0 zs_0) x_96 x_19)) (stoogesort_0 x_100 x_19))))
(assert (forall ((x_101 list_0) (x_102 list_0) (x_103 list_0) (x_22 Nat_0) (x_23 list_0) (y_16 Nat_0) (y_15 Nat_0))
	(=> (and (stoogesort_0 x_102 (cons_0 y_15 (cons_0 y_16 (cons_0 x_22 x_23)))) (stoogesort_2 x_103 x_102) (stoogesort_0 x_101 x_103)) (stoogesort_1 x_101 (cons_0 y_15 (cons_0 y_16 (cons_0 x_22 x_23)))))))
(assert (forall ((x_105 list_0) (y_16 Nat_0) (y_15 Nat_0))
	(=> (sort_0 x_105 y_15 y_16) (stoogesort_1 x_105 (cons_0 y_15 (cons_0 y_16 nil_0))))))
...
(assert (forall ((x_112 list_0) (x_113 list_0) (x_109 Nat_0) (x_110 Nat_0) (ys_1 list_0) (zs_1 list_0) (x_24 list_0))
	(=> (and (stoogesort_1 x_113 zs_1) (x_14 x_112 ys_1 x_113) (length_0 x_109 x_24) (idiv_0 x_110 x_109 (succ_0 (succ_0 (succ_0 zero_0)))) (splitAt_0 (pair_1 ys_1 zs_1) x_110 x_24)) (stoogesort_2 x_112 x_24))))
(assert (forall ((x_115 Nat_0) (x_116 Nat_0) (x_117 Nat_0) (x_118 Nat_0) (x_25 Nat_0) (y_17 Nat_0) (z_12 Nat_0))
	(=> (and (diseqNat_0 x_116 x_118) (times_0 x_115 y_17 z_12) (times_0 x_116 x_25 x_115) (times_0 x_117 x_25 y_17) (times_0 x_118 x_117 z_12)) false)))
(assert (forall ((x_119 Nat_0) (x_120 Nat_0) (x_121 Nat_0) (x_122 Nat_0) (x_26 Nat_0) (y_18 Nat_0) (z_13 Nat_0))
	(=> (and (diseqNat_0 x_120 x_122) (plus_0 x_119 y_18 z_13) (plus_0 x_120 x_26 x_119) (plus_0 x_121 x_26 y_18) (plus_0 x_122 x_121 z_13)) false)))
(assert (forall ((x_123 Nat_0) (x_124 Nat_0) (x_27 Nat_0) (y_19 Nat_0))
	(=> (and (diseqNat_0 x_123 x_124) (times_0 x_123 x_27 y_19) (times_0 x_124 y_19 x_27)) false)))
(assert (forall ((x_125 Nat_0) (x_126 Nat_0) (x_28 Nat_0) (y_20 Nat_0))
	(=> (and (diseqNat_0 x_125 x_126) (plus_0 x_125 x_28 y_20) (plus_0 x_126 y_20 x_28)) false)))
(assert (forall ((x_127 Nat_0) (x_128 Nat_0) (x_129 Nat_0) (x_130 Nat_0) (x_131 Nat_0) (x_29 Nat_0) (y_21 Nat_0) (z_14 Nat_0))
	(=> (and (diseqNat_0 x_128 x_131) (plus_0 x_127 y_21 z_14) (times_0 x_128 x_29 x_127) (times_0 x_129 x_29 y_21) (times_0 x_130 x_29 z_14) (plus_0 x_131 x_129 x_130)) false)))
(assert (forall ((x_132 Nat_0) (x_133 Nat_0) (x_134 Nat_0) (x_135 Nat_0) (x_136 Nat_0) (x_30 Nat_0) (y_22 Nat_0) (z_15 Nat_0))
	(=> (and (diseqNat_0 x_133 x_136) (plus_0 x_132 x_30 y_22) (times_0 x_133 x_132 z_15) (times_0 x_134 x_30 z_15) (times_0 x_135 y_22 z_15) (plus_0 x_136 x_134 x_135)) false)))
(assert (forall ((x_137 Nat_0) (x_31 Nat_0))
	(=> (and (diseqNat_0 x_137 x_31) (times_0 x_137 x_31 (succ_0 zero_0))) false)))
(assert (forall ((x_138 Nat_0) (x_32 Nat_0))
	(=> (and (diseqNat_0 x_138 x_32) (times_0 x_138 (succ_0 zero_0) x_32)) false)))
(assert (forall ((x_139 Nat_0) (x_33 Nat_0))
	(=> (and (diseqNat_0 x_139 x_33) (plus_0 x_139 x_33 zero_0)) false)))
(assert (forall ((x_140 Nat_0) (x_34 Nat_0))
	(=> (and (diseqNat_0 x_140 x_34) (plus_0 x_140 zero_0 x_34)) false)))
(assert (forall ((x_141 Nat_0) (x_35 Nat_0))
	(=> (and (diseqNat_0 x_141 zero_0) (times_0 x_141 x_35 zero_0)) false)))
(assert (forall ((x_142 Nat_0) (x_36 Nat_0))
	(=> (and (diseqNat_0 x_142 zero_0) (times_0 x_142 zero_0 x_36)) false)))
(assert (forall ((x_143 list_0) (x_144 list_0) (xs_5 list_0))
	(=> (and (diseqlist_0 x_143 x_144) (stoogesort_1 x_143 xs_5) (isort_0 x_144 xs_5)) false)))
(check-sat)
(get-model)
