...
(assert (forall ((x_10 Nat_1) (y_2 Nat_1))
	(=> (lt_0 x_10 y_2)
	    (lt_0 (S_0 x_10) (S_0 y_2)))))
(assert (forall ((y_2 Nat_1))
	(gt_0 (S_0 y_2) Z_0)))
(assert (forall ((x_10 Nat_1) (y_2 Nat_1))
	(=> (gt_0 x_10 y_2)
	    (gt_0 (S_0 x_10) (S_0 y_2)))))
(assert (forall ((y_2 Nat_1))
	(mult_0 Z_0 Z_0 y_2)))
(assert (forall ((x_10 Nat_1) (y_2 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (mult_0 r_0 x_10 y_2)
			(add_0 z_2 r_0 y_2))
		(mult_0 z_2 (S_0 x_10) y_2))))
(assert (forall ((x_10 Nat_1) (y_2 Nat_1))
	(=> (lt_0 x_10 y_2)
	    (div_0 Z_0 x_10 y_2))))
(assert (forall ((x_10 Nat_1) (y_2 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (ge_0 x_10 y_2)
			(minus_0 z_2 x_10 y_2)
			(div_0 r_0 z_2 y_2))
...
(assert (forall ((x_0 Nat_0) (y_0 Nat_0) (x_6 Bool))
	(=>	(and (= x_6 true)
			(= x_0 zero_0))
		(leq_0 x_6 x_0 y_0))))
(assert (forall ((x_2 Nat_0) (y_1 Nat_0) (z_1 Nat_0) (x_7 Bool) (x_8 Bool) (x_9 Bool))
	(=>	(and (= x_7 false)
			(= x_8 true)
			(= x_9 true)
			(leq_0 x_7 x_2 z_1)
