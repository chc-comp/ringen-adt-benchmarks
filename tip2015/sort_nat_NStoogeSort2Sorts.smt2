...
(assert (forall ((x_52 Nat_0) (x_53 Nat_0) (x_54 Nat_0) (y_5 Nat_0))
	(=> (and (diseqNat_0 (succ_0 y_5) (succ_0 (succ_0 zero_0))) (diseqNat_0 (succ_0 y_5) (succ_0 zero_0)) (minus_0 x_53 (succ_0 y_5) (succ_0 (succ_0 (succ_0 zero_0)))) (twoThirds_0 x_54 x_53) (plus_0 x_52 (succ_0 (succ_0 zero_0)) x_54)) (twoThirds_0 x_52 (succ_0 y_5)))))
(assert (twoThirds_0 (succ_0 zero_0) (succ_0 (succ_0 zero_0))))
(assert (=> (diseqNat_0 (succ_0 zero_0) (succ_0 (succ_0 zero_0))) (twoThirds_0 (succ_0 zero_0) (succ_0 zero_0))))
(assert (twoThirds_0 (succ_0 zero_0) (succ_0 (succ_0 zero_0))))
...
(assert (forall ((x_60 Bool_0) (x_6 Nat_0) (z_4 Nat_0))
	(=> (leq_0 x_60 z_4 x_6) (leq_0 x_60 (succ_0 z_4) (succ_0 x_6)))))
...
(assert (forall ((x_117 Bool_0) (x_65 Bool_0) (x_66 Bool_0) (y_8 Nat_0) (xs_1 list_0) (y_7 Nat_0))
	(=> (and (leq_0 x_65 y_7 y_8) (ordered_0 x_66 (cons_0 y_8 xs_1)) (and_0 x_117 x_65 x_66)) (ordered_0 x_117 (cons_0 y_7 (cons_0 y_8 xs_1))))))
...
(assert (forall ((x_71 Bool_0) (x_8 Nat_0) (y_9 Nat_0))
	(=> (and (diseqBool_0 x_71 true_0) (leq_0 x_71 x_8 y_9)) (sort_0 (cons_0 y_9 (cons_0 x_8 nil_0)) x_8 y_9))))
(assert (forall ((x_73 Nat_0) (x_74 Nat_0) (y_10 Nat_0) (l_0 list_0))
	(=> (and (length_0 x_74 l_0) (plus_0 x_73 (succ_0 zero_0) x_74)) (length_0 x_73 (cons_0 y_10 l_0)))))
(assert (length_0 zero_0 nil_0))
(assert (forall ((x_77 list_0) (z_7 Nat_0) (xs_2 list_0) (z_6 Nat_0))
	(=> (drop_0 x_77 z_6 xs_2) (drop_0 x_77 (succ_0 z_6) (cons_0 z_7 xs_2)))))
...
(assert (forall ((x_82 list_0) (x_83 list_0) (x_11 Nat_0) (y_12 list_0))
	(=> (and (take_0 x_82 x_11 y_12) (drop_0 x_83 x_11 y_12)) (splitAt_0 (pair_1 x_82 x_83) x_11 y_12))))
(assert (forall ((x_85 list_0) (z_8 Nat_0) (xs_3 list_0) (y_13 list_0))
	(=> (x_12 x_85 xs_3 y_13) (x_12 (cons_0 z_8 x_85) (cons_0 z_8 xs_3) y_13))))
...
(assert (forall ((x_90 list_0) (x_91 list_0) (x_87 Nat_0) (x_88 Nat_0) (ys_0 list_0) (zs_0 list_0) (x_17 list_0))
	(=> (and (nstoogesort_1 x_91 ys_0) (x_12 x_90 x_91 zs_0) (length_0 x_87 x_17) (twoThirds_0 x_88 x_87) (splitAt_0 (pair_1 ys_0 zs_0) x_88 x_17)) (nstoogesort_0 x_90 x_17))))
(assert (forall ((x_93 list_0) (x_94 list_0) (x_95 list_0) (x_20 Nat_0) (x_21 list_0) (y_15 Nat_0) (y_14 Nat_0))
	(=> (and (nstoogesort_0 x_94 (cons_0 y_14 (cons_0 y_15 (cons_0 x_20 x_21)))) (nstoogesort_2 x_95 x_94) (nstoogesort_0 x_93 x_95)) (nstoogesort_1 x_93 (cons_0 y_14 (cons_0 y_15 (cons_0 x_20 x_21)))))))
(assert (forall ((x_97 list_0) (y_15 Nat_0) (y_14 Nat_0))
	(=> (sort_0 x_97 y_14 y_15) (nstoogesort_1 x_97 (cons_0 y_14 (cons_0 y_15 nil_0))))))
...
(assert (forall ((x_104 list_0) (x_105 list_0) (x_101 Nat_0) (x_102 Nat_0) (ys_1 list_0) (zs_1 list_0) (x_22 list_0))
	(=> (and (nstoogesort_1 x_105 zs_1) (x_12 x_104 ys_1 x_105) (length_0 x_101 x_22) (third_0 x_102 x_101) (splitAt_0 (pair_1 ys_1 zs_1) x_102 x_22)) (nstoogesort_2 x_104 x_22))))
(assert (forall ((x_107 Nat_0) (x_108 Nat_0) (x_109 Nat_0) (x_110 Nat_0) (x_23 Nat_0) (y_16 Nat_0) (z_10 Nat_0))
	(=> (and (diseqNat_0 x_108 x_110) (plus_0 x_107 y_16 z_10) (plus_0 x_108 x_23 x_107) (plus_0 x_109 x_23 y_16) (plus_0 x_110 x_109 z_10)) false)))
(assert (forall ((x_111 Nat_0) (x_112 Nat_0) (x_24 Nat_0) (y_17 Nat_0))
	(=> (and (diseqNat_0 x_111 x_112) (plus_0 x_111 x_24 y_17) (plus_0 x_112 y_17 x_24)) false)))
(assert (forall ((x_113 Nat_0) (x_25 Nat_0))
	(=> (and (diseqNat_0 x_113 x_25) (plus_0 x_113 x_25 zero_0)) false)))
(assert (forall ((x_114 Nat_0) (x_26 Nat_0))
	(=> (and (diseqNat_0 x_114 x_26) (plus_0 x_114 zero_0 x_26)) false)))
(assert (forall ((x_115 list_0) (x_116 Bool_0) (xs_4 list_0))
	(=> (and (diseqBool_0 x_116 true_0) (nstoogesort_1 x_115 xs_4) (ordered_0 x_116 x_115)) false)))
(check-sat)
(get-model)
