...
(assert (forall ((x_55 Nat_0) (x_56 Nat_0))
	(=> (diseqNat_0 x_55 x_56) (diseqNat_0 (succ_0 x_55) (succ_0 x_56)))))
...
(assert (forall ((x_67 Nat_0) (x_68 Nat_0))
	(=> (diseqNat_0 x_67 x_68) (diseqInteger_0 (P_1 x_67) (P_1 x_68)))))
(assert (forall ((x_69 Nat_0) (x_70 Nat_0))
	(=> (diseqNat_0 x_69 x_70) (diseqInteger_0 (N_0 x_69) (N_0 x_70)))))
...
(assert (forall ((x_38 Integer_0) (x_39 Integer_0) (x_7 Integer_0) (y_3 Integer_0))
	(=> (and (diseqInteger_0 x_38 x_39) (plus_1 x_38 x_7 y_3) (plus_1 x_39 y_3 x_7)) false)))
(assert (forall ((x_40 Nat_0) (x_41 Nat_0) (x_42 Nat_0) (x_43 Nat_0) (x_8 Nat_0) (y_4 Nat_0) (z_2 Nat_0))
	(=> (and (diseqNat_0 x_41 x_43) (plus_0 x_40 y_4 z_2) (plus_0 x_41 x_8 x_40) (plus_0 x_42 x_8 y_4) (plus_0 x_43 x_42 z_2)) false)))
(assert (forall ((x_44 Nat_0) (x_45 Nat_0) (x_9 Nat_0) (y_5 Nat_0))
	(=> (and (diseqNat_0 x_44 x_45) (plus_0 x_44 x_9 y_5) (plus_0 x_45 y_5 x_9)) false)))
(assert (forall ((x_46 Nat_0) (x_10 Nat_0))
	(=> (and (diseqNat_0 x_46 x_10) (plus_0 x_46 x_10 zero_0)) false)))
(assert (forall ((x_47 Nat_0) (x_11 Nat_0))
	(=> (and (diseqNat_0 x_47 x_11) (plus_0 x_47 zero_0 x_11)) false)))
(check-sat)
(get-model)
