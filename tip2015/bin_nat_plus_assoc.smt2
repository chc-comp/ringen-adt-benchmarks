...
(assert (forall ((x_35 Bin_0))
	(diseqBin_0 One_0 (ZeroAnd_0 x_35))))
(assert (forall ((x_36 Bin_0))
	(diseqBin_0 One_0 (OneAnd_0 x_36))))
(assert (forall ((x_37 Bin_0))
	(diseqBin_0 (ZeroAnd_0 x_37) One_0)))
(assert (forall ((x_38 Bin_0))
	(diseqBin_0 (OneAnd_0 x_38) One_0)))
(assert (forall ((x_39 Bin_0) (x_40 Bin_0))
	(diseqBin_0 (ZeroAnd_0 x_39) (OneAnd_0 x_40))))
(assert (forall ((x_41 Bin_0) (x_42 Bin_0))
	(diseqBin_0 (OneAnd_0 x_41) (ZeroAnd_0 x_42))))
(assert (forall ((x_43 Bin_0) (x_44 Bin_0))
	(=> (diseqBin_0 x_43 x_44) (diseqBin_0 (ZeroAnd_0 x_43) (ZeroAnd_0 x_44)))))
(assert (forall ((x_45 Bin_0) (x_46 Bin_0))
	(=> (diseqBin_0 x_45 x_46) (diseqBin_0 (OneAnd_0 x_45) (OneAnd_0 x_46)))))
...
(assert (forall ((x_23 Bin_0) (x_24 Bin_0) (x_25 Bin_0) (x_26 Bin_0) (x_3 Bin_0) (y_1 Bin_0) (z_1 Bin_0))
	(=> (and (diseqBin_0 x_24 x_26) (plus_0 x_23 y_1 z_1) (plus_0 x_24 x_3 x_23) (plus_0 x_25 x_3 y_1) (plus_0 x_26 x_25 z_1)) false)))
(check-sat)
(get-model)
