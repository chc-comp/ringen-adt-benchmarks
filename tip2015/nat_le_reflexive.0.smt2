...
(assert (forall ((x_8 Nat_1) (y_1 Nat_1) (r_0 Nat_1))
	(=> (add_0 r_0 x_8 y_1)
	    (add_0 (S_0 r_0) (S_0 x_8) y_1))))
(assert (forall ((y_1 Nat_1))
	(minus_0 Z_0 Z_0 y_1)))
(assert (forall ((x_8 Nat_1) (y_1 Nat_1) (r_0 Nat_1))
	(=> (minus_0 r_0 x_8 y_1)
	    (minus_0 (S_0 r_0) (S_0 x_8) y_1))))
(assert (forall ((y_1 Nat_1))
	(le_0 Z_0 y_1)))
(assert (forall ((x_8 Nat_1) (y_1 Nat_1))
	(=> (le_0 x_8 y_1)
	    (le_0 (S_0 x_8) (S_0 y_1)))))
(assert (forall ((y_1 Nat_1))
	(ge_0 y_1 Z_0)))
(assert (forall ((x_8 Nat_1) (y_1 Nat_1))
	(=> (ge_0 x_8 y_1)
	    (ge_0 (S_0 x_8) (S_0 y_1)))))
(assert (forall ((y_1 Nat_1))
	(lt_0 Z_0 (S_0 y_1))))
(assert (forall ((x_8 Nat_1) (y_1 Nat_1))
	(=> (lt_0 x_8 y_1)
	    (lt_0 (S_0 x_8) (S_0 y_1)))))
(assert (forall ((y_1 Nat_1))
	(gt_0 (S_0 y_1) Z_0)))
(assert (forall ((x_8 Nat_1) (y_1 Nat_1))
	(=> (gt_0 x_8 y_1)
	    (gt_0 (S_0 x_8) (S_0 y_1)))))
(assert (forall ((y_1 Nat_1))
	(mult_0 Z_0 Z_0 y_1)))
(assert (forall ((x_8 Nat_1) (y_1 Nat_1) (r_0 Nat_1) (z_1 Nat_1))
	(=>	(and (mult_0 r_0 x_8 y_1)
			(add_0 z_1 r_0 y_1))
		(mult_0 z_1 (S_0 x_8) y_1))))
(assert (forall ((x_8 Nat_1) (y_1 Nat_1))
	(=> (lt_0 x_8 y_1)
	    (div_0 Z_0 x_8 y_1))))
(assert (forall ((x_8 Nat_1) (y_1 Nat_1) (r_0 Nat_1) (z_1 Nat_1))
