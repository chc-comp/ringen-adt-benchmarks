...
(assert (forall ((x_4 Nat_0) (y_2 Nat_0) (x_24 Nat_0))
	(=>	(and (= x_24 zero_0)
			(= x_4 zero_0))
		(mul_0 x_24 x_4 y_2))))
(assert (forall ((x_6 Nat_0) (y_3 Nat_0) (z_3 Nat_0) (x_25 Nat_0) (x_26 Nat_0) (x_27 Nat_0) (x_28 Nat_0))
	(=>	(and (diseqNat_1 x_26 x_28)
			...
			(mul_0 x_28 x_27 z_3))
		false)))
(assert (forall ((x_7 Nat_0) (y_4 Nat_0) (z_4 Nat_0) (x_29 Nat_0) (x_30 Nat_0) (x_31 Nat_0) (x_32 Nat_0))
	(=>	(and (diseqNat_1 x_30 x_32)
		...
		false)))
(assert (forall ((x_8 Nat_0) (y_5 Nat_0) (x_33 Nat_0) (x_34 Nat_0))
	(=>	(and (diseqNat_1 x_33 x_34)
			(plus_0 x_33 x_8 y_5)
			(plus_0 x_34 y_5 x_8))
		false)))
(assert (forall ((x_9 Nat_0) (x_35 Nat_0))
	(=>	(and (diseqNat_1 x_35 x_9)
			(plus_0 x_35 x_9 zero_0))
		false)))
(assert (forall ((x_10 Nat_0) (x_36 Nat_0))
	(=>	(and (diseqNat_1 x_36 x_10)
