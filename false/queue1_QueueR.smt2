...
(assert (forall ((x_118 list_0) (as_2 list_0) (cs_0 list_0) (z_10 Nat_0) (x_28 list_0))
	(=> (and (reverse_0 x_118 cs_0) (halve_0 (pair_3 as_2 cs_0) (cons_0 z_10 x_28))) (mkQ_0 (Q_1 as_2 x_118) (cons_0 z_10 x_28) nil_0))))
(assert (forall ((x_121 list_0) (as_1 list_0) (bs_1 list_0) (y_14 list_0))
	(=> (and (reverse_0 x_121 as_1) (halve_0 (pair_3 as_1 bs_1) y_14)) (mkQ_0 (Q_1 x_121 bs_1) nil_0 y_14))))
(assert (forall ((x_122 Q_0) (x_123 list_0) (x_124 list_0) (x_125 list_0) (x_126 list_0) (vs_0 list_0) (ws_0 list_0) (xs_6 list_0) (ys_1 list_0))
	(=> (and (reverse_0 x_123 ys_1) (x_21 x_124 xs_6 x_123) (reverse_0 x_125 vs_0) (x_21 x_126 ws_0 x_125) (mkQ_0 x_122 x_124 x_126)) (x_31 x_122 (Q_1 xs_6 ys_1) (Q_1 vs_0 ws_0)))))
