...
(assert (forall ((x_22 list_0) (y_13 list_0) (z_9 Nat_0) (x_23 list_0) (as_1 list_0) (cs_0 list_0) (x_105 Q_0) (x_106 list_0) (x_104 pair_2))
	(=>	(and (= x_105 (Q_1 as_1 x_106))
			(reverse_0 x_106 cs_0)
			(= x_22 (cons_0 z_9 x_23))
			(= y_13 nil_0)
			(= x_104 (pair_3 as_1 cs_0))
			(halve_0 x_104 (cons_0 z_9 x_23)))
		(mkQ_0 x_105 x_22 y_13))))
(assert (forall ((x_22 list_0) (y_13 list_0) (as_2 list_0) (bs_1 list_0) (x_108 Q_0) (x_109 list_0) (x_107 pair_2))
	(=>	(and (= x_108 (Q_1 x_109 bs_1))
			(reverse_0 x_109 as_2)
			(= x_22 nil_0)
			(= x_107 (pair_3 as_2 bs_1))
			(halve_0 x_107 y_13))
