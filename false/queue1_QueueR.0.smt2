...
(assert (forall ((x_27 list_0) (y_14 list_0) (z_10 Nat_0) (x_28 list_0) (as_1 list_0) (cs_0 list_0) (x_117 Q_0) (x_118 list_0) (x_116 pair_2))
	(=>	(and (= x_117 (Q_1 as_1 x_118))
			(reverse_0 x_118 cs_0)
			(= x_27 (cons_0 z_10 x_28))
			(= y_14 nil_0)
			(= x_116 (pair_3 as_1 cs_0))
			(halve_0 x_116 (cons_0 z_10 x_28)))
		(mkQ_0 x_117 x_27 y_14))))
(assert (forall ((x_27 list_0) (y_14 list_0) (as_2 list_0) (bs_1 list_0) (x_120 Q_0) (x_121 list_0) (x_119 pair_2))
	(=>	(and (= x_120 (Q_1 x_121 bs_1))
			(reverse_0 x_121 as_2)
			(= x_27 nil_0)
			(= x_119 (pair_3 as_2 bs_1))
			(halve_0 x_119 y_14))
