...
(assert (forall ((a_1 list_1) (x_68 list_1) (x_69 list_2) (x_70 list_3) (x_71 list_2) (x_72 list_1) (x_73 list_2) (x_74 list_2) (x_75 Bool) (x_76 list_0) (x_77 Bool) (x_87 Nat_0) (x_88 Nat_0))
	(=>	(and true
			...
			(petersen_2 x_70 (S_0 (S_0 (S_0 (S_0 (S_0 Z_0))))) (cons_2 (pair_1 x_88 Z_0) x_69))
			(concat_0 x_71 x_70)
			(primEnumFromTo_0 x_72 Z_0 (S_0 (S_0 (S_0 (S_0 (S_0 Z_0))))))
			(petersen_0 x_73 (S_0 (S_0 (S_0 (S_0 (S_0 Z_0))))) x_72)
			(x_11 x_74 x_71 x_73)
			(colouring_1 x_75 x_74 a_1)
			(formula_0 x_76 a_1)
			(and_0 x_77 x_76)
			(minus_0 x_87 (S_0 (S_0 (S_0 (S_0 (S_0 Z_0))))) (S_0 Z_0))
			(minus_0 x_88 (S_0 (S_0 (S_0 (S_0 (S_0 Z_0))))) (S_0 Z_0)))
		false)))
(check-sat)
