...
(assert (forall ((x_30 Nat_0) (x_31 Nat_0))
	(=> (diseqNat_0 x_30 x_31) (diseqNat_0 (S_0 x_30) (S_0 x_31)))))
...
(assert (forall ((x_42 Nat_0) (x_43 list_0) (x_44 Nat_0) (x_45 list_0))
	(=> (diseqNat_0 x_42 x_44) (diseqlist_0 (cons_0 x_42 x_43) (cons_0 x_44 x_45)))))
(assert (forall ((x_42 Nat_0) (x_43 list_0) (x_44 Nat_0) (x_45 list_0))
	(=> (diseqlist_0 x_43 x_45) (diseqlist_0 (cons_0 x_42 x_43) (cons_0 x_44 x_45)))))
...
(assert (forall ((x_10 list_0) (z_1 Nat_0) (xs_1 list_0) (y_1 list_0))
	(=> (x_1 x_10 xs_1 y_1) (x_1 (cons_0 z_1 x_10) (cons_0 z_1 xs_1) y_1))))
...
(assert (forall ((x_21 Nat_0) (x_17 Nat_0) (x_18 list_0) (x_19 list_0) (xs_2 list_0) (ys_0 list_0))
	(=> (and (diseqlist_0 xs_2 ys_0) (length_0 x_21 xs_2) (length_0 x_21 ys_0) (length_0 x_17 xs_2) (x_1 x_18 xs_2 ys_0) (rotate_0 x_19 x_17 x_18) (x_1 x_19 xs_2 ys_0)) false)))
(check-sat)
(get-model)
