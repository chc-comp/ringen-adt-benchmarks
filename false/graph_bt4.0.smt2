...
(assert (forall ((p_0 list_4) (x_165 list_1) (x_166 list_2) (x_167 list_1) (x_168 list_2) (x_169 list_1) (x_170 list_2) (x_171 list_1) (x_172 list_2) (x_173 list_1) (x_174 list_2) (x_175 list_1) (x_176 list_2) (x_177 list_2) (x_178 list_2) (x_179 list_2) (x_180 list_2) (x_181 list_2) (x_182 Bool) (x_228 Nat_0) (x_229 Nat_0) (x_230 Nat_0) (x_231 Nat_0) (x_232 Nat_0) (x_233 Nat_0) (x_234 Nat_0) (x_235 Nat_0) (x_236 Nat_0) (x_237 Nat_0) (x_238 Nat_0) (x_239 Nat_0) (x_240 Nat_0))
	(=>	(and (= x_182 true)
			...
			(primEnumFromTo_0 x_167 Z_0 (S_0 (S_0 (S_0 (S_0 Z_0)))))
			(dodeca_4 x_168 (S_0 (S_0 (S_0 (S_0 Z_0)))) x_167)
			(primEnumFromTo_0 x_169 Z_0 (S_0 (S_0 (S_0 (S_0 Z_0)))))
			(dodeca_3 x_170 (S_0 (S_0 (S_0 (S_0 Z_0)))) x_169)
			(primEnumFromTo_0 x_171 Z_0 x_229)
			(dodeca_2 x_172 (S_0 (S_0 (S_0 (S_0 Z_0)))) x_171)
			(primEnumFromTo_0 x_173 Z_0 (S_0 (S_0 (S_0 (S_0 Z_0)))))
			(dodeca_1 x_174 (S_0 (S_0 (S_0 (S_0 Z_0)))) x_173)
			(primEnumFromTo_0 x_175 Z_0 x_230)
			(dodeca_0 x_176 (S_0 (S_0 (S_0 (S_0 Z_0)))) x_175)
			(x_37 x_177 x_174 (cons_2 (pair_1 x_234 x_236) x_176))
			(x_37 x_178 (cons_2 (pair_1 (S_0 (S_0 (S_0 (S_0 Z_0)))) x_239) x_172) x_177)
			(x_37 x_179 x_170 x_178)
			(x_37 x_180 x_168 x_179)
			(x_37 x_181 (cons_2 (pair_1 x_240 Z_0) x_166) x_180)
			(btour_0 x_182 p_0 x_181)
			(minus_0 x_228 (S_0 (S_0 (S_0 (S_0 Z_0)))) (S_0 Z_0))
			(minus_0 x_229 (S_0 (S_0 (S_0 (S_0 Z_0)))) (S_0 Z_0))
			(minus_0 x_230 (S_0 (S_0 (S_0 (S_0 Z_0)))) (S_0 Z_0))
			(add_0 x_231 (S_0 (S_0 (S_0 (S_0 Z_0)))) (S_0 (S_0 (S_0 (S_0 Z_0)))))
			(add_0 x_232 x_231 (S_0 (S_0 (S_0 (S_0 Z_0)))))
			(minus_0 x_233 (S_0 (S_0 (S_0 (S_0 Z_0)))) (S_0 Z_0))
			(add_0 x_234 x_232 x_233)
			(add_0 x_235 (S_0 (S_0 (S_0 (S_0 Z_0)))) (S_0 (S_0 (S_0 (S_0 Z_0)))))
			(add_0 x_236 x_235 (S_0 (S_0 (S_0 (S_0 Z_0)))))
			(add_0 x_237 (S_0 (S_0 (S_0 (S_0 Z_0)))) (S_0 (S_0 (S_0 (S_0 Z_0)))))
			(minus_0 x_238 (S_0 (S_0 (S_0 (S_0 Z_0)))) (S_0 Z_0))
			(add_0 x_239 x_237 x_238)
			(minus_0 x_240 (S_0 (S_0 (S_0 (S_0 Z_0)))) (S_0 Z_0)))
		false)))
(check-sat)
