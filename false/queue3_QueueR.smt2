...
(assert (forall ((x_184 Nat_0) (x_185 Nat_0))
	(=> (diseqNat_0 x_184 x_185) (diseqNat_0 (Z_15 x_184) (Z_15 x_185)))))
(assert (forall ((y_21 Nat_0))
	(add_0 y_21 Z_14 y_21)))
(assert (forall ((r_1 Nat_0) (x_173 Nat_0) (y_21 Nat_0))
	(=> (add_0 r_1 x_173 y_21) (add_0 (Z_15 r_1) (Z_15 x_173) y_21))))
(assert (forall ((y_21 Nat_0))
	(minus_0 Z_14 Z_14 y_21)))
(assert (forall ((r_1 Nat_0) (x_173 Nat_0) (y_21 Nat_0))
	(=> (minus_0 r_1 x_173 y_21) (minus_0 (Z_15 r_1) (Z_15 x_173) y_21))))
(assert (forall ((y_21 Nat_0))
	(le_0 Z_14 y_21)))
(assert (forall ((x_173 Nat_0) (y_21 Nat_0))
	(=> (le_0 x_173 y_21) (le_0 (Z_15 x_173) (Z_15 y_21)))))
(assert (forall ((y_21 Nat_0))
	(ge_0 y_21 Z_14)))
(assert (forall ((x_173 Nat_0) (y_21 Nat_0))
	(=> (ge_0 x_173 y_21) (ge_0 (Z_15 x_173) (Z_15 y_21)))))
(assert (forall ((y_21 Nat_0))
	(lt_0 Z_14 (Z_15 y_21))))
(assert (forall ((x_173 Nat_0) (y_21 Nat_0))
	(=> (lt_0 x_173 y_21) (lt_0 (Z_15 x_173) (Z_15 y_21)))))
(assert (forall ((y_21 Nat_0))
	(gt_0 (Z_15 y_21) Z_14)))
(assert (forall ((x_173 Nat_0) (y_21 Nat_0))
	(=> (gt_0 x_173 y_21) (gt_0 (Z_15 x_173) (Z_15 y_21)))))
(assert (forall ((x_173 Nat_0) (y_21 Nat_0))
	(=> (lt_0 x_173 y_21) (div_0 Z_14 x_173 y_21))))
(assert (forall ((r_1 Nat_0) (x_173 Nat_0) (y_21 Nat_0) (z_16 Nat_0))
	(=> (and (ge_0 x_173 y_21) (minus_0 z_16 x_173 y_21) (div_0 r_1 z_16 y_21)) (div_0 (Z_15 r_1) x_173 y_21))))
...
(assert (forall ((x_233 Nat_0) (x_234 Nat_0))
	(=> (diseqNat_0 x_233 x_234) (diseqMaybe_0 (Just_0 x_233) (Just_0 x_234)))))
...
(assert (forall ((x_174 Nat_0) (x_50 list_0) (z_0 Nat_0) (xs_0 list_0) (x_0 Nat_0))
	(=> (and (gt_0 x_0 Z_14) (take_0 x_50 x_174 xs_0) (minus_0 x_174 x_0 (Z_15 Z_14))) (take_0 (cons_0 z_0 x_50) x_0 (cons_0 z_0 xs_0)))))
(assert (forall ((x_0 Nat_0) (y_0 list_0))
	(=> (le_0 x_0 Z_14) (take_0 nil_0 x_0 y_0))))
...
(assert (forall ((x_175 Nat_0) (x_56 Nat_0) (y_2 Nat_0) (l_0 list_0))
	(=> (and (length_0 x_56 l_0) (add_0 x_175 (Z_15 Z_14) x_56)) (length_0 x_175 (cons_0 y_2 l_0)))))
...
(assert (forall ((x_176 Nat_0) (x_80 list_0) (z_6 Nat_0) (xs_2 list_0) (x_19 Nat_0))
	(=> (and (gt_0 x_19 Z_14) (drop_0 x_80 x_176 xs_2) (minus_0 x_176 x_19 (Z_15 Z_14))) (drop_0 x_80 x_19 (cons_0 z_6 xs_2)))))
...
(assert (forall ((x_112 list_0) (x_113 list_0) (x_114 list_0) (x_115 list_0) (vs_0 list_0) (ws_0 list_0) (xs_5 list_0) (ys_0 list_0))
	(=> (and (reverse_0 x_112 ys_0) (x_21 x_113 xs_5 x_112) (reverse_0 x_114 vs_0) (x_21 x_115 ws_0 x_114)) (x_25 (Q_1 x_113 x_115) (Q_1 xs_5 ys_0) (Q_1 vs_0 ws_0)))))
...
(assert (forall ((x_119 list_0) (as_0 list_0) (bs_0 list_0) (xs_6 list_0) (x_27 Nat_0))
	(=> (and (reverse_0 x_119 bs_0) (halve_0 (pair_3 as_0 bs_0) (cons_0 x_27 xs_6))) (enqL_1 (Q_1 as_0 x_119) x_27 (Q_1 xs_6 nil_0)))))
...
(assert (forall ((x_123 list_0) (as_2 list_0) (bs_2 list_0) (z_10 Nat_0) (x_30 list_0))
	(=> (and (reverse_0 x_123 bs_2) (halve_0 (pair_3 as_2 bs_2) (cons_0 z_10 x_30))) (mkQ_0 (Q_1 as_2 x_123) (cons_0 z_10 x_30) nil_0))))
(assert (forall ((x_126 list_0) (as_1 list_0) (bs_1 list_0) (y_15 list_0))
	(=> (and (reverse_0 x_126 bs_1) (halve_0 (pair_3 as_1 bs_1) y_15)) (mkQ_0 (Q_1 x_126 as_1) nil_0 y_15))))
(assert (forall ((x_128 Q_0) (x_38 Nat_0) (xs_7 list_0) (z_11 list_0))
	(=> (mkQ_0 x_128 xs_7 z_11) (deqL_1 (Just_1 x_128) (Q_1 (cons_0 x_38 xs_7) z_11)))))
...
(assert (forall ((x_131 Q_0) (x_34 Nat_0))
	(=> (empty_1 x_131) (deqL_1 (Just_1 x_131) (Q_1 nil_0 (cons_0 x_34 nil_0))))))
(assert (deqL_1 Nothing_1 (Q_1 nil_0 nil_0)))
(assert (forall ((x_133 Q_0) (x_44 Nat_0) (x_45 list_0) (x_40 Nat_0) (y_18 Nat_0) (ys_2 list_0))
	(=> (mkQ_0 x_133 (cons_0 x_40 (cons_0 x_44 x_45)) ys_2) (deqR_1 (Just_1 x_133) (Q_1 (cons_0 x_40 (cons_0 x_44 x_45)) (cons_0 y_18 ys_2))))))
(assert (forall ((x_135 Q_0) (x_42 Nat_0) (x_43 list_0) (x_40 Nat_0))
	(=> (mkQ_0 x_135 (cons_0 x_40 nil_0) x_43) (deqR_1 (Just_1 x_135) (Q_1 (cons_0 x_40 nil_0) (cons_0 x_42 x_43))))))
(assert (forall ((x_140 Q_0) (y_18 Nat_0) (ys_2 list_0))
	(=> (mkQ_0 x_140 nil_0 ys_2) (deqR_1 (Just_1 x_140) (Q_1 nil_0 (cons_0 y_18 ys_2))))))
...
(assert (forall ((x_145 Q_0) (x_40 Nat_0))
	(=> (empty_1 x_145) (deqR_1 (Just_1 x_145) (Q_1 (cons_0 x_40 nil_0) nil_0)))))
(assert (deqR_1 Nothing_1 (Q_1 nil_0 nil_0)))
(assert (forall ((x_147 Q_0) (xs_8 list_0) (ys_3 list_0) (y_19 Nat_0))
	(=> (mkQ_0 x_147 xs_8 (cons_0 y_19 ys_3)) (enqR_1 x_147 (Q_1 xs_8 ys_3) y_19))))
(assert (forall ((x_149 Q_0) (x_150 Q_0) (x_151 Q_0) (a_1 E_0) (b_1 E_0))
	(=> (and (queue_0 x_150 a_1) (queue_0 x_151 b_1) (x_25 x_149 x_150 x_151)) (queue_0 x_149 (App_0 a_1 b_1)))))
(assert (forall ((x_154 Q_0) (x_155 Maybe_1) (r_0 Q_0) (e_8 E_0))
	(=> (and (deqR_1 x_155 r_0) (fromMaybe_1 x_154 r_0 x_155) (queue_0 r_0 e_8)) (queue_0 x_154 (DeqR_0 e_8)))))
(assert (forall ((x_158 Q_0) (x_159 Maybe_1) (q_2 Q_0) (e_7 E_0))
	(=> (and (deqL_1 x_159 q_2) (fromMaybe_1 x_158 q_2 x_159) (queue_0 q_2 e_7)) (queue_0 x_158 (DeqL_0 e_7)))))
(assert (forall ((x_161 Q_0) (x_162 Q_0) (e_6 E_0) (z_13 Nat_0))
	(=> (and (queue_0 x_162 e_6) (enqR_1 x_161 x_162 z_13)) (queue_0 x_161 (EnqR_0 e_6 z_13)))))
(assert (forall ((x_164 Q_0) (x_165 Q_0) (y_20 Nat_0) (e_5 E_0))
	(=> (and (queue_0 x_165 e_5) (enqL_1 x_164 y_20 x_165)) (queue_0 x_164 (EnqL_0 y_20 e_5)))))
(assert (forall ((x_167 Q_0))
	(=> (empty_1 x_167) (queue_0 x_167 Empty_0))))
(assert (forall ((x_169 Q_0) (x_170 Maybe_0) (x_171 list_0) (x_172 Maybe_0) (e_9 E_0))
	(=> (and (diseqMaybe_0 x_170 x_172) (queue_0 x_169 e_9) (fstR_0 x_170 x_169) (list_1 x_171 e_9) (last_0 x_172 x_171)) false)))
(check-sat)
(get-model)
