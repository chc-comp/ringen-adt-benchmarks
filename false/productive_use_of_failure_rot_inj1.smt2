...
(assert (forall ((x_34 Nat_0) (x_35 list_0) (x_36 Nat_0) (x_37 list_0))
	(=> (diseqNat_0 x_34 x_36) (diseqlist_0 (cons_0 x_34 x_35) (cons_0 x_36 x_37)))))
(assert (forall ((x_34 Nat_0) (x_35 list_0) (x_36 Nat_0) (x_37 list_0))
	(=> (diseqlist_0 x_35 x_37) (diseqlist_0 (cons_0 x_34 x_35) (cons_0 x_36 x_37)))))
...
(assert (forall ((x_13 list_0) (n_0 Nat_0) (ys_0 list_0) (xs_1 list_0))
	(=> (and (diseqlist_0 xs_1 ys_0) (rotate_0 x_13 n_0 xs_1) (rotate_0 x_13 n_0 ys_0)) false)))
(check-sat)
(get-model)
