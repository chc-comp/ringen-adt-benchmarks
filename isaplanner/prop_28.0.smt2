...
(assert (forall ((y_4 Nat_1))
	(add_0 y_4 Z_1 y_4)))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1) (r_0 Nat_1))
	(=> (add_0 r_0 x_23 y_4)
	    (add_0 (S_1 r_0) (S_1 x_23) y_4))))
(assert (forall ((y_4 Nat_1))
	(minus_0 Z_1 Z_1 y_4)))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1) (r_0 Nat_1))
	(=> (minus_0 r_0 x_23 y_4)
	    (minus_0 (S_1 r_0) (S_1 x_23) y_4))))
(assert (forall ((y_4 Nat_1))
	(le_0 Z_1 y_4)))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1))
	(=> (le_0 x_23 y_4)
	    (le_0 (S_1 x_23) (S_1 y_4)))))
(assert (forall ((y_4 Nat_1))
	(ge_0 y_4 Z_1)))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1))
	(=> (ge_0 x_23 y_4)
	    (ge_0 (S_1 x_23) (S_1 y_4)))))
(assert (forall ((y_4 Nat_1))
	(lt_0 Z_1 (S_1 y_4))))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1))
	(=> (lt_0 x_23 y_4)
	    (lt_0 (S_1 x_23) (S_1 y_4)))))
(assert (forall ((y_4 Nat_1))
	(gt_0 (S_1 y_4) Z_1)))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1))
	(=> (gt_0 x_23 y_4)
	    (gt_0 (S_1 x_23) (S_1 y_4)))))
(assert (forall ((y_4 Nat_1))
	(mult_0 Z_1 Z_1 y_4)))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1) (r_0 Nat_1) (z_3 Nat_1))
	(=>	(and (mult_0 r_0 x_23 y_4)
			(add_0 z_3 r_0 y_4))
		(mult_0 z_3 (S_1 x_23) y_4))))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1))
	(=> (lt_0 x_23 y_4)
	    (div_0 Z_1 x_23 y_4))))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1) (r_0 Nat_1) (z_3 Nat_1))
	(=>	(and (ge_0 x_23 y_4)
			(minus_0 z_3 x_23 y_4)
			(div_0 r_0 z_3 y_4))
		(div_0 (S_1 r_0) x_23 y_4))))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1))
	(=> (lt_0 x_23 y_4)
	    (mod_0 x_23 x_23 y_4))))
(assert (forall ((x_23 Nat_1) (y_4 Nat_1) (r_0 Nat_1) (z_3 Nat_1))
...
(assert (forall ((x_5 list_0) (y_3 list_0) (x_20 list_0))
	(=>	(and (= x_20 y_3)
			(= x_5 nil_0))
		(x_4 x_20 x_5 y_3))))
(assert (forall ((x_6 Nat_0) (xs_2 list_0) (x_21 list_0) (x_22 Bool))
	(=>	(and (= x_22 false)
