...
(assert (forall ((x_14 Bool_0) (x_13 Bool_0) (z_2 Nat_0) (xs_0 list_0) (x_3 Nat_0))
	(=> (and (diseqBool_0 x_13 true_0) (elem_0 x_14 x_3 xs_0) (x_0 x_13 x_3 z_2)) (elem_0 x_14 x_3 (cons_0 z_2 xs_0)))))
(assert (forall ((x_3 Nat_0))
	(elem_0 false_0 x_3 nil_0)))
(assert (forall ((z_3 Nat_0) (xs_1 list_0) (x_4 Nat_0))
	(=> (x_0 true_0 x_4 z_3) (ins_0 (cons_0 z_3 xs_1) x_4 (cons_0 z_3 xs_1)))))
(assert (forall ((x_21 list_0) (x_19 Bool_0) (z_3 Nat_0) (xs_1 list_0) (x_4 Nat_0))
	(=> (and (diseqBool_0 x_19 true_0) (ins_0 x_21 x_4 xs_1) (x_0 x_19 x_4 z_3)) (ins_0 (cons_0 z_3 x_21) x_4 (cons_0 z_3 xs_1)))))
(assert (forall ((x_4 Nat_0))
	(ins_0 (cons_0 x_4 nil_0) x_4 nil_0)))
(assert (forall ((x_23 list_0) (x_24 Bool_0) (x_5 Nat_0) (xs_2 list_0))
	(=> (and (diseqBool_0 x_24 true_0) (ins_0 x_23 x_5 xs_2) (elem_0 x_24 x_5 x_23)) false)))
(check-sat)
(get-model)
