...
(assert (forall ((y_5 Nat_1))
	(mult_0 Z_1 Z_1 y_5)))
(assert (forall ((x_32 Nat_1) (y_5 Nat_1) (r_0 Nat_1) (z_4 Nat_1))
	(=>	(and (mult_0 r_0 x_32 y_5)
			(add_0 z_4 r_0 y_5))
		(mult_0 z_4 (S_1 x_32) y_5))))
(assert (forall ((x_32 Nat_1) (y_5 Nat_1))
	(=> (lt_0 x_32 y_5)
	    (div_0 Z_1 x_32 y_5))))
(assert (forall ((x_32 Nat_1) (y_5 Nat_1) (r_0 Nat_1) (z_4 Nat_1))
	(=>	(and (ge_0 x_32 y_5)
			(minus_0 z_4 x_32 y_5)
			(div_0 r_0 z_4 y_5))
...
(assert (forall ((x_7 Nat_0) (y_4 list_0) (x_29 list_0))
	(=>	(and (= x_29 (cons_0 x_7 nil_0))
			(= y_4 nil_0))
		(ins_0 x_29 x_7 y_4))))
(assert (forall ((x_8 Nat_0) (xs_2 list_0) (x_30 list_0) (x_31 Bool))
	(=>	(and (= x_31 false)
			(ins_0 x_30 x_8 xs_2)
