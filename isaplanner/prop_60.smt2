...
(assert (forall ((x_26 Nat_0) (x_27 Nat_0))
	(=> (diseqNat_0 x_26 x_27) (diseqNat_0 (S_0 x_26) (S_0 x_27)))))
...
(assert (forall ((x_13 list_0) (x_14 Nat_0) (x_15 Nat_0) (x_5 Nat_0) (y_2 list_0) (xs_1 list_0))
	(=> (and (diseqNat_0 x_14 x_15) true (x_3 x_13 xs_1 (cons_0 x_5 y_2)) (last_0 x_14 x_13) (last_0 x_15 (cons_0 x_5 y_2))) false)))
(assert (forall ((x_16 list_0) (x_17 Nat_0) (x_18 Nat_0) (xs_1 list_0))
	(=> (and (diseqNat_0 x_17 x_18) false (x_3 x_16 xs_1 nil_0) (last_0 x_17 x_16) (last_0 x_18 nil_0)) false)))
(check-sat)
(get-model)
