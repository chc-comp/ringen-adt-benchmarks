...
(assert (forall ((y_5 Nat_1))
	(mult_0 Z_1 Z_1 y_5)))
(assert (forall ((x_31 Nat_1) (y_5 Nat_1) (r_0 Nat_1) (z_3 Nat_1))
	(=>	(and (mult_0 r_0 x_31 y_5)
			(add_0 z_3 r_0 y_5))
		(mult_0 z_3 (S_1 x_31) y_5))))
(assert (forall ((x_31 Nat_1) (y_5 Nat_1))
	(=> (lt_0 x_31 y_5)
	    (div_0 Z_1 x_31 y_5))))
(assert (forall ((x_31 Nat_1) (y_5 Nat_1) (r_0 Nat_1) (z_3 Nat_1))
	(=>	(and (ge_0 x_31 y_5)
			(minus_0 z_3 x_31 y_5)
			(div_0 r_0 z_3 y_5))
...
(assert (forall ((x_0 list_0) (y_0 Nat_0) (xs_0 list_0) (x_8 Nat_0) (x_9 Nat_0))
	(=>	(and (= x_8 (S_0 x_9))
			(len_0 x_9 xs_0)
			(= x_0 (cons_0 y_0 xs_0)))
		(len_0 x_8 x_0))))
...
(assert (forall ((x_2 Nat_0) (y_1 Nat_0) (x_3 Nat_0) (y_2 Nat_0) (x_11 Bool) (x_12 Bool))
	(=>	(and (= x_11 x_12)
			(x_1 x_12 x_3 y_2)
			(= x_2 (S_0 x_3))
			(= y_1 (S_0 y_2)))
...
(assert (forall ((x_2 Nat_0) (y_1 Nat_0) (z_0 Nat_0) (x_14 Bool))
	(=>	(and (= x_14 false)
			...
			(= y_1 (S_0 z_0)))
		(x_1 x_14 x_2 y_1))))
(assert (forall ((x_2 Nat_0) (y_1 Nat_0) (x_15 Bool))
	(=>	(and (= x_15 true)
			(= x_2 Z_0)
			(= y_1 Z_0))
		(x_1 x_15 x_2 y_1))))
(declare-fun delete_0 (list_0 Nat_0 list_0) Bool)
(assert (forall ((x_4 Nat_0) (y_3 list_0) (z_1 Nat_0) (xs_1 list_0) (x_17 list_0) (x_18 list_0) (x_16 Bool))
	(=>	(and (= x_17 x_18)
			(delete_0 x_18 x_4 xs_1)
			(= y_3 (cons_0 z_1 xs_1))
			(= x_16 true)
			(x_1 x_16 x_4 z_1))
		(delete_0 x_17 x_4 y_3))))
(assert (forall ((x_4 Nat_0) (y_3 list_0) (z_1 Nat_0) (xs_1 list_0) (x_20 list_0) (x_21 list_0) (x_19 Bool))
	(=>	(and (= x_20 (cons_0 z_1 x_21))
			(delete_0 x_21 x_4 xs_1)
			(= y_3 (cons_0 z_1 xs_1))
			(= x_19 false)
			(x_1 x_19 x_4 z_1))
		(delete_0 x_20 x_4 y_3))))
(assert (forall ((x_4 Nat_0) (y_3 list_0) (x_22 list_0))
	(=>	(and (= x_22 nil_0)
			(= y_3 nil_0))
		(delete_0 x_22 x_4 y_3))))
...
(assert (forall ((x_6 Nat_0) (y_4 Nat_0) (x_26 Bool))
	(=>	(and (= x_26 true)
			(= x_6 Z_0))
		(x_5 x_26 x_6 y_4))))
(assert (forall ((n_0 Nat_0) (xs_2 list_0) (x_27 list_0) (x_28 Nat_0) (x_29 Nat_0) (x_30 Bool))
	(=>	(and (= x_30 false)
