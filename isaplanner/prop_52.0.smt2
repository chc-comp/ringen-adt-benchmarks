...
(assert (forall ((x_5 list_0) (y_3 list_0) (z_2 Nat_0) (xs_0 list_0) (x_19 list_0) (x_20 list_0))
	(=>	(and (= x_19 (cons_0 z_2 x_20))
			(x_4 x_20 xs_0 y_3)
			(= x_5 (cons_0 z_2 xs_0)))
		(x_4 x_19 x_5 y_3))))
(assert (forall ((x_5 list_0) (y_3 list_0) (x_21 list_0))
	(=>	(and (= x_21 y_3)
			(= x_5 nil_0))
		(x_4 x_21 x_5 y_3))))
(declare-fun rev_0 (list_0 list_0) Bool)
(assert (forall ((x_6 list_0) (y_4 Nat_0) (xs_1 list_0) (x_22 list_0) (x_23 list_0) (x_24 list_0))
	(=>	(and (= x_22 x_24)
			(rev_0 x_23 xs_1)
			(x_4 x_24 x_23 (cons_0 y_4 nil_0))
			(= x_6 (cons_0 y_4 xs_1)))
		(rev_0 x_22 x_6))))
(assert (forall ((x_6 list_0) (x_25 list_0))
	(=>	(and (= x_25 nil_0)
			(= x_6 nil_0))
		(rev_0 x_25 x_6))))
(assert (forall ((n_0 Nat_0) (xs_2 list_0) (x_26 Nat_0) (x_27 list_0) (x_28 Nat_0))
	(=>	(and (diseqNat_1 x_26 x_28)
