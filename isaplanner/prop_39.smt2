...
(assert (forall ((x_20 Nat_0) (z_3 Nat_0) (y_3 Nat_0))
	(=> (x_4 x_20 z_3 y_3) (x_4 (S_0 x_20) (S_0 z_3) y_3))))
(assert (forall ((x_21 Nat_0))
	(x_4 x_21 Z_0 x_21)))
(assert (forall ((x_22 Nat_0) (x_23 Nat_0) (x_24 Nat_0) (x_25 Nat_0) (n_0 Nat_0) (x_6 Nat_0) (xs_0 list_0))
	(=> (and (diseqNat_0 x_24 x_25) (count_0 x_22 n_0 (cons_0 x_6 nil_0)) (count_0 x_23 n_0 xs_0) (x_4 x_24 x_22 x_23) (count_0 x_25 n_0 (cons_0 x_6 xs_0))) false)))
(check-sat)
(get-model)
