...
(assert (forall ((y_4 Nat_1))
	(mult_0 Z_1 Z_1 y_4)))
(assert (forall ((x_26 Nat_1) (y_4 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (mult_0 r_0 x_26 y_4)
			(add_0 z_2 r_0 y_4))
		(mult_0 z_2 (S_1 x_26) y_4))))
(assert (forall ((x_26 Nat_1) (y_4 Nat_1))
	(=> (lt_0 x_26 y_4)
	    (div_0 Z_1 x_26 y_4))))
(assert (forall ((x_26 Nat_1) (y_4 Nat_1) (r_0 Nat_1) (z_2 Nat_1))
	(=>	(and (ge_0 x_26 y_4)
			(minus_0 z_2 x_26 y_4)
			(div_0 r_0 z_2 y_4))
...
(assert (forall ((x_4 Nat_0) (y_2 list_0) (z_1 Nat_0) (xs_1 list_0) (x_16 list_0) (x_17 list_0) (x_15 Bool))
	(=>	(and (= x_16 (cons_0 z_1 x_17))
			...
			(= x_15 false)
			(x_1 x_15 x_4 z_1))
		(insort_0 x_16 x_4 y_2))))
(assert (forall ((x_4 Nat_0) (y_2 list_0) (x_18 list_0))
	(=>	(and (= x_18 (cons_0 x_4 nil_0))
			(= y_2 nil_0))
		(insort_0 x_18 x_4 y_2))))
(declare-fun sort_0 (list_0 list_0) Bool)
(assert (forall ((x_5 list_0) (y_3 Nat_0) (xs_2 list_0) (x_19 list_0) (x_20 list_0) (x_21 list_0))
	(=>	(and (= x_19 x_21)
			(sort_0 x_20 xs_2)
			(insort_0 x_21 y_3 x_20)
			(= x_5 (cons_0 y_3 xs_2)))
		(sort_0 x_19 x_5))))
(assert (forall ((x_5 list_0) (x_22 list_0))
	(=>	(and (= x_22 nil_0)
			(= x_5 nil_0))
		(sort_0 x_22 x_5))))
(assert (forall ((xs_3 list_0) (x_23 list_0) (x_24 Nat_0) (x_25 Nat_0))
