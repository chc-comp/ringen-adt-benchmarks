...
(assert (forall ((x_14 list_0) (x_5 Nat_1) (x_6 list_0) (z_2 Nat_0))
	(=> (drop_0 x_14 z_2 x_6) (drop_0 x_14 (S_0 z_2) (cons_0 x_5 x_6)))))
...
(assert (forall ((x_18 list_1) (x_8 pair_0) (x_9 list_1) (z_3 Nat_0))
	(=> (drop_1 x_18 z_3 x_9) (drop_1 x_18 (S_0 z_3) (cons_1 x_8 x_9)))))
...
(assert (forall ((x_22 list_1) (x_23 list_1) (x_24 list_0) (x_25 list_0) (x_26 list_1) (n_0 Nat_0) (xs_0 list_0) (ys_0 list_0))
	(=> (and (diseqlist_1 x_23 x_26) (zip_0 x_22 xs_0 ys_0) (drop_1 x_23 n_0 x_22) (drop_0 x_24 n_0 xs_0) (drop_0 x_25 n_0 ys_0) (zip_0 x_26 x_24 x_25)) false)))
(check-sat)
(get-model)
