...
(assert (forall ((x_1 Nat_0) (y_1 list_0) (z_0 Nat_0) (x_2 Nat_1) (x_3 list_0) (x_10 list_0) (x_11 list_0))
	(=>	(and (= x_10 x_11)
			(drop_0 x_11 z_0 x_3)
			(= x_1 (S_0 z_0))
			(= y_1 (cons_0 x_2 x_3)))
		(drop_0 x_10 x_1 y_1))))
(assert (forall ((x_1 Nat_0) (y_1 list_0) (z_0 Nat_0) (x_12 list_0))
	(=>	(and (= x_12 nil_0)
			(= x_1 (S_0 z_0))
			(= y_1 nil_0))
		(drop_0 x_12 x_1 y_1))))
(assert (forall ((x_1 Nat_0) (y_1 list_0) (x_13 list_0))
	(=>	(and (= x_13 y_1)
			(= x_1 Z_0))
		(drop_0 x_13 x_1 y_1))))
...
(assert (forall ((x_5 Nat_0) (y_2 Nat_0) (x_17 Nat_0))
	(=>	(and (= x_17 Z_0)
			(= x_5 Z_0))
		(x_4 x_17 x_5 y_2))))
(assert (forall ((n_0 Nat_0) (xs_1 list_0) (x_18 list_0) (x_19 Nat_0) (x_20 Nat_0) (x_21 Nat_0))
	(=>	(and (diseqNat_1 x_19 x_21)
			(drop_0 x_18 n_0 xs_1)
			(len_0 x_19 x_18)
			(len_0 x_20 xs_1)
			(x_4 x_21 x_20 n_0))
		false)))
