...
(assert (forall ((x_0 list_0) (y_0 Nat_0) (z_0 list_0) (x_1 Nat_0) (x_2 list_0) (x_5 Nat_0) (x_6 Nat_0))
	(=>	(and (= x_5 x_6)
			(last_0 x_6 (cons_0 x_1 x_2))
			(= x_0 (cons_0 y_0 z_0))
			(= z_0 (cons_0 x_1 x_2)))
		(last_0 x_5 x_0))))
(assert (forall ((x_0 list_0) (y_0 Nat_0) (z_0 list_0) (x_7 Nat_0))
	(=>	(and (= x_7 y_0)
			(= x_0 (cons_0 y_0 z_0))
			(= z_0 nil_0))
		(last_0 x_7 x_0))))
...
(assert (forall ((x_4 list_0) (y_1 list_0) (z_1 Nat_0) (xs_0 list_0) (x_9 list_0) (x_10 list_0))
	(=>	(and (= x_9 (cons_0 z_1 x_10))
			(x_3 x_10 xs_0 y_1)
			(= x_4 (cons_0 z_1 xs_0)))
		(x_3 x_9 x_4 y_1))))
(assert (forall ((x_4 list_0) (y_1 list_0) (x_11 list_0))
	(=>	(and (= x_11 y_1)
			(= x_4 nil_0))
		(x_3 x_11 x_4 y_1))))
(assert (forall ((xs_1 list_0) (ys_0 list_0) (x_12 list_0) (x_13 Nat_0) (x_14 Nat_0))
