...
(assert (forall ((x_10 Nat_0) (y_0 Nat_1) (xs_0 list_0))
	(=> (len_0 x_10 xs_0) (len_0 (S_0 x_10) (cons_0 y_0 xs_0)))))
(assert (len_0 Z_0 nil_0))
(assert (forall ((x_12 list_0) (x_2 Nat_1) (x_3 list_0) (z_1 Nat_0))
	(=> (drop_0 x_12 z_1 x_3) (drop_0 x_12 (S_0 z_1) (cons_0 x_2 x_3)))))
...
(assert (forall ((x_23 list_0) (x_24 list_0) (x_25 list_0) (x_26 Nat_0) (x_27 Nat_0) (x_28 list_0) (x_29 list_0) (n_0 Nat_0) (xs_2 list_0) (ys_0 list_0))
	(=> (and (diseqlist_0 x_24 x_29) (x_7 x_23 xs_2 ys_0) (drop_0 x_24 n_0 x_23) (drop_0 x_25 n_0 xs_2) (len_0 x_26 xs_2) (x_4 x_27 n_0 x_26) (drop_0 x_28 x_27 ys_0) (x_7 x_29 x_25 x_28)) false)))
(check-sat)
(get-model)
