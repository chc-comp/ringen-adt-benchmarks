...
(assert (forall ((x_10 list_0) (x_2 Nat_1) (x_3 list_0) (z_1 Nat_0))
	(=> (drop_0 x_10 z_1 x_3) (drop_0 x_10 (S_0 z_1) (cons_0 x_2 x_3)))))
(assert (forall ((z_1 Nat_0))
	(drop_0 nil_0 (S_0 z_1) nil_0)))
(assert (forall ((x_13 list_0))
	(drop_0 x_13 Z_0 x_13)))
...
(assert (forall ((y_2 Nat_0))
	(x_4 Z_0 Z_0 y_2)))
(assert (forall ((x_18 list_0) (x_19 Nat_0) (x_20 Nat_0) (x_21 Nat_0) (n_0 Nat_0) (xs_1 list_0))
	(=> (and (diseqNat_0 x_19 x_21) (drop_0 x_18 n_0 xs_1) (len_0 x_19 x_18) (len_0 x_20 xs_1) (x_4 x_21 x_20 n_0)) false)))
(check-sat)
(get-model)
