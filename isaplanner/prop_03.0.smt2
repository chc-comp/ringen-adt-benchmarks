...
(assert (forall ((x_8 list_0) (y_4 list_0) (z_3 Nat_0) (xs_0 list_0) (x_25 list_0) (x_26 list_0))
	(=>	(and (= x_25 (cons_0 z_3 x_26))
			(x_7 x_26 xs_0 y_4)
			(= x_8 (cons_0 z_3 xs_0)))
		(x_7 x_25 x_8 y_4))))
(assert (forall ((x_8 list_0) (y_4 list_0) (x_27 list_0))
	(=>	(and (= x_27 y_4)
			(= x_8 nil_0))
		(x_7 x_27 x_8 y_4))))
(assert (forall ((n_0 Nat_0) (xs_1 list_0) (ys_1 list_0) (x_28 Nat_0) (x_29 list_0) (x_30 Nat_0) (x_31 Bool))
	(=>	(and (= x_31 false)
